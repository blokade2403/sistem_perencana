                                        ...
                                        <td>
                                            <div class="btn-group" id="dropdown-icon-demo">
                                                ...
                                                <ul class="dropdown-menu">
                                                    <li>
                                                        <a href="{{ route('jabatans.edit', $key->id_jabatan) }}" class="dropdown-item d-flex align-items-center"><i class="mdi mdi-chevron-right scaleX-n1-rtl"></i>Edit</a>
                                                    </li>
                                                    <form action="{{ route('jabatans.destroy', $key->id_jabatan) }}" method="POST" class="delete-form">
                                                        @csrf
                                                        @method('DELETE')
