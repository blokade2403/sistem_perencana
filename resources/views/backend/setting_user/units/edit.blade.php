...
<div class="content-wrapper">
    <!-- Content -->
        <form class="needs-validation" method="POST" action="{{ route('units.update', $unit->id_unit) }}">
            @csrf
            @method('PUT')
            <div class="col-xl-12">
                <div class="card-body">
                        ...
                        <div class="card-body pt-1">
                            <div class="row">
                                        ...
                                        <div class="col-12 col-md-12">
                                            <div class="input-group input-group-merge">
                                                ...
                                                <div class="form-floating form-floating-outline">
                                                    <input type="text" class="form-control" name="nama_unit" value="{{$unit->nama_unit}}" id="basic-addon11" placeholder="John Doe" aria-label="tahun_anggaranname" aria-describedby="basic-addon11" />
                                ...
                                <div class="mt-2">
                                    ...
                                    <a href="/units" class="btn btn-outline-secondary">Back</a>
                                </div>
                            </div>
                        </div>
