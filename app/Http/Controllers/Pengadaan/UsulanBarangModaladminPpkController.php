...
class UsulanBarangModaladminPpkController extends Controller
{
    public function index($id_sub_kategori_rkbu = null)
    {
        ...
        $sub_kategori_rkbus = SubKategoriRkbu::join('kategori_rkbus', 'sub_kategori_rkbus.id_kategori_rkbu', '=', 'kategori_rkbus.id_kategori_rkbu')
            ...
            ->where('jenis_kategori_rkbus.id_jenis_kategori_rkbu', $jenis_kategori_modal)
        ...
        return view('backend.pengadaan.usulan_belanja.index_modal', compact('usulan_barangs', 'get_barangs', 'id_usulan', 'sub_kategori_rkbus'));
    }
    ...
    public function show($id_usulan_barang)
    {
        ...
        return view('backend.pengadaan.usulan_belanja.invoice_modal', $data, compact('sub_kategori_rkbus', 'usulan_barangs', 'id_usulan', 'invoice'));
    }
    ...
    public function edit($id)
    {
        ...
        // Kirim data ke view
        return view('backend.pengadaan.usulan_belanja.edit_modal', compact('usulan_barang_details', 'rkbu', 'uraian1', 'uraian2'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        if ($totalAnggaranSetelahUpdate <= $rkbu->total_anggaran) {
            ...
            return redirect()->route('usulan_belanja_modal_admin_ppks.index', $usulanBarangDetail->id_usulan_barang)
