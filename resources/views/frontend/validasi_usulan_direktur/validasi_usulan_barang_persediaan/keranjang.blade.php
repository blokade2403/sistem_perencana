            ...
            <div class="card invoice-preview-card">
                ...
                <div class="col-12">
                    <div class="card-body">
                        ...
                        <form action="{{route('validasi_usul_persediaan_dirs.updateValidasi', $no_inv->no_usulan_barang)}}" method="POST" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                            ...
                            <div class="card-body">
                                ...
                                <div class="mt-2">
                                    ...
                                    @else
                                        ...
                                        <a href="{{route('validasi_usul_persediaan_dirs.index')}}" class="btn btn-outline-secondary">Kembali</a>
                                    @endif
                                </div>
                            </div>
                        </form>
