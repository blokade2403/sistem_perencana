        ...
        <div class="col-lg-12 col-12 mb-lg-0 mb-4">
            <div class="card invoice-preview-card">
                <div class="card-body">
                    ...
                    <hr>
                    <div class="row text-center">
                        <p class="mt-1 mb-1"><strong>DATA USULAN BELANJA BARANG PERSEDIAAN</strong></p>
                    </div>
                    <br />
                ...
                <div class="col-12">
                    <div class="card-body">
                        ...
                        <div class="mt-2">
                            ...
                            <a href="{{route('usulan_barang_persediaans.index')}}" class="btn btn-outline-secondary">Kembali</a>
                        </form>
                        </div>
                    </div>
                </div>
