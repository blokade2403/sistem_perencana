        ...
        <div class="modal-content p-3 p-md-5">
            <div class="modal-body pt-3 pt-md-0 px-0 pb-md-0">
                ...
                <div class="text-center mb-4">
                    ...
                    <h3 class="mb-2">Upload Data Asset</h3>
                    <p class="text-center w-75 m-auto mt-1">
                        Upload Data Inventory Asset
                    </p>
                </div>
                <form action="{{route('barang_assets.import')}}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="col-lg-10">
                    ...
                    <div class="col-lg-9">
                        <label class="form-label fw-normal" for="modalRnFLink"><a href="{{ route('barang_assets.downloadReport') }}" class="btn btn-outline-secondary btn-primary"> Download Format. 🥳 </a></label>
                    </div>
