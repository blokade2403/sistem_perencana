                ...
                <div class="card col-12 mb-4">
                    <div class="user-profile-header d-flex flex-column flex-sm-row text-sm-start text-center mb-4">
                        <div class="flex-shrink-0 mt-n2 mx-sm-0 mx-auto">
                            <img src="assets/img/illustrations/pricing-illustration.png" height="157" width="175" alt="user image" class="d-block h-auto ms-0 ms-sm-4 rounded user-profile-img" />
                        </div>
                                ...
                                <div class="user-profile-info">
                                    ...
                                    <div class="demo-inline-spacing">
                                        <div class="d-flex justify-content-start align-items-center gap-2">
                                            <a href="{{route('realisasi_rba.downloadPDF_realisasi_kertas_kerja')}}" class="btn btn-icon btn-outline-info waves-effect" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-custom-class="tooltip-info" data-bs-original-title="Print PDF ">
                ...
                <div class="card-body">
                    ...
                    <div class="row mb-2 align-items-center">
                        ...
                        <div class="col-md-5 center">
                            <div class="text-center"><strong class="fa-sm">LAPORAN REALISASI PENYERAPAN ANGGARAN</strong> </div>
                            <div class="text-center"><span class="fa-sm">TAHUN ANGGARAN </span>{{session('tahun_anggaran')}}</div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-2">
                            <div class="text-left"><span class="fa-sm"><strong>UKPD</strong></span></div>
                            <div class="text-left"><span class="fa-sm">Pengguna Anggaran</span></div>
                            <div class="text-left"><span class="fa-sm">Bendahara Pengeluaran</span></div>
                        </div>
                        <div class="col-md-8">
                            <div class="text-left"><span class="fa-sm">: {{$nama}}</span></div>
                            <div class="text-left"><span class="fa-sm">: {{$jabatan_direktur->nama_pejabat ?? 'Tidak ada data'}}</span></div>
                            <div class="text-left"><span class="fa-sm">: {{$bendahara->nama_bendahara ?? 'Tidak ada data'}}</span></div>
                        </div>
                    </div>
                        ...
                        <table class="table table-striped">
                                    ...
                                    @foreach ($jenisBelanja->jenis_kategori_rkbus as $jenisKategori)
                                        <thead>
                                            <tr class="fa-md" style="background-color: #e0e9f4; color: rgb(63, 63, 63); opacity: 212;">
                                                ...
                                                <td class="text-left fa-sm"> {{ number_format($jenisKategori->total_anggaran - $jenisKategori->realisasi_anggaran, 0, ',', '.') }}</td>
                                                <td class="text-left fa-sm">
                                            ...
                                            @foreach ($obyekBelanja->kategori_rkbus as $kategoriRkbu)
                                                <thead>
                                                    <tr style="background-color: #f2f3f3; color: rgb(63, 63, 63); opacity: 212;">
                                                        ...
                                                        <td class="text-left fa-sm"> {{ number_format($kategoriRkbu->total_anggaran - $kategoriRkbu->realisasi_anggaran, 0, ',', '.') }}</td>
                                                        <td class="text-left fa-sm">
                                                ...
                                                @foreach ($kategoriRkbu->sub_kategori_rkbus as $subKategoriRkbu)
                                                    <thead>
                                                        <tr>
                                                            ...
                                                            <td class="text-left fa-sm"> {{ number_format($subKategoriRkbu->total_anggaran - $subKategoriRkbu->realisasi_anggaran, 0, ',', '.') }}</td>
                                                            <td class="text-left fa-sm">
                            ...
                            <tfoot class="thead-primary">
                                <tr>
                                    ...
                                    <th class="text-left fs-14 text">Rp. {{ number_format($total_anggaran_blud, 0, ',', '.') }}</th>
                                    <th class="text-left fs-14 text">Rp</th>
                                    <th class="text-left fs-14 text">Rp</th>
