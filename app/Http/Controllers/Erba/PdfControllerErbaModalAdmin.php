...
class PdfControllerErbaModalAdmin extends Controller
{
    public function downloadPDF(Request $request)
    {
        ...
        <table border="0">
            ...
            <tr>
                <td width="100%" align="center">
                    ...
                    <h3 style="font-weight: normal; font-size:8px; line-height:0;">ANGGARAN  BELANJA MODAL TAHUN ANGGARAN ' . $tahunAnggaran . '</h3>
                </td>
            </tr>
        </table>';
        ...
        $htmlBody = view('erba.print_erba_modal', compact('rkbus', 'tanggal_perencanaans', 'jabatan_kabag', 'nama_rumah_sakit', 'nama_pejabat', 'nip_pejabat_kabag', 'nip_direktur', 'nama_direktur', 'pdf', 'sub_kategori_rkbus', 'status_validasi_rka', 'total_anggaran', 'categories', 'namaProgram', 'namaKegiatan', 'namaSubKegiatan', 'kodeProgram', 'kodeKegiatan', 'kodeSubKegiatan'))->render();
