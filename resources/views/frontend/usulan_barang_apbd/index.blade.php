                            ...
                            <table id="example" class="table table-striped" style="width:100%">
                                ...
                                <tbody>
                                    @php
                                            ...
                                            @include('frontend.partials.modal_komponen_usulan_barang')
                                            </td>
                                            <td><a href="{{ route('usulan_barang_barjass.keranjang', $key->id_usulan_barang) }}" class="btn btn-sm btn-info">
                                            ...
                                            <td>
                                                ...
                                                <form action="{{ route('usulan_barang_barjass.delete', $key->id_usulan_barang) }}" method="POST" class="delete-form">
                                                    @csrf
                                                    @method('DELETE')
