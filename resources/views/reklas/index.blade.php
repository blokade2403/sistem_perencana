                                ...
                                <div class="user-profile-info">
                                    ...
                                    <div class="btn-toolbar demo-inline-spacing" role="toolbar" aria-label="Toolbar with button groups">
                                        <div class="demo-inline-spacing">
                                            <a href="{{route('reklas_arbs.cetakQRCode')}}" class="btn rounded-pill btn-label-success waves-effect">
                                                <span class="tf-icons mdi mdi-printer me-1"></span>Print
                                            </a>
                                            <a href="{{route('reklas_arbs.export')}}" class="btn rounded-pill btn-label-warning waves-effect">
