...
class ValidasiControllerPegawaiNonPnsAdmin extends Controller
{
    /**
    ...
    public function index(Request $request)
    {
        ...
        return view('frontend.Ringkasan_Blud.pegawai_non_pns.index', compact(
            'rkbus',
            'total_anggaran',
            'sub_kategori_rkbus',
            'status_validasi_rka',
    ...
    public function edit(string $id)
    {
        ...
        return view('frontend.Ringkasan_Blud.pegawai_non_pns.edit', compact('rkbuBarangJasa', 'rekening_belanja', 'status_validasi_rka', 'status_validasi', 'komponens', 'sub_kategori_rkbus', 'uraian_satu', 'uraian_dua'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        // Redirect dengan pesan sukses
        return redirect()->route('validasi_pegawai_non_pns_admins.index')->with('success', 'Data berhasil diperbarui.');
    }
