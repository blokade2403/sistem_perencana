...
<div class="content-wrapper">
    <!-- Content -->
        ...
        @endif
        <form class="needs-validation" action="{{route('rkbu_modal_alkess.store')}}"  method="POST" id="confirmSubmitForm" enctype="multipart/form-data" validate>
            @csrf
            <div class="col-xl-12">
                <div class="card-body">
                    <div class="card mb-4">
                                        ...
                                        <div class="col-6 col-md-12 mb-4">
                                            <div class="form-floating form-floating-outline">
                                                ...
                                                <div class="form-floating mt-3">
                                                    ...
                                                    <input type="hidden" id="id_kode_rekening_belanja" name="id_kode_rekening_belanja" value="9cf603e2-e748-49f0-949f-6c3c30d42c3e" class="form-control" placeholder="ID Kategori RKBU" readonly>
                                                </div>
