            ...
            <div class="card-body">
                    <!-- Content -->
                                                ...
                                                <div class="user-profile-info">
                                                    ...
                                                    <ul class="list-inline mb-0 d-flex align-items-center flex-wrap justify-content-sm-start justify-content-center gap-2">
                                                        ...
                                                        <div class="demo-inline-spacing">
                                                            ...
                                                            <a href="{{route('validasi_pegawai_non_pns_rkas.downloadPDF_ValidasiPegawaiNonPnsKabag')}}" class="btn rounded-pill btn-label-warning waves-effect">
                        ...
                        <div class="col-12">
                            <div class="card">
                                    <div class="card-body">
                                        <form action="{{ route('validasi_pegawai_non_pns_rkas.index') }}" method="GET">
                                                                     ...
                                                                     <div class="demo-inline-spacing">
                                                                        ...
                                                                        <div class="btn-group" id="dropdown-icon-demo">
                                                                            ...
                                                                            <ul class="dropdown-menu">
                                                                                <li>
                                                                                    <a href="{{ route('validasi_pegawai_non_pns_rkas.edit', $rkbus->id_rkbu) }}" class="dropdown-item d-flex align-items-center"><i class="mdi mdi-chevron-right scaleX-n1-rtl"></i>Edit</a>
                                                                                </li>
                                                                                <form action="{{route('validasi_pegawai_non_pns_rkas.destroy', $rkbus->id_rkbu)}}" method="POST" class="delete-form">
                                                                                    @csrf
                                                                                    @method('DELETE')
