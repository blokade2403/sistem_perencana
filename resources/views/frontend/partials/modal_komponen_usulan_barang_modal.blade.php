    ...
    <div class="modal-dialog modal-xl" role="document">
        <div class="modal-content text-center">
            ...
            <div class="modal-body">
                ...
                <div class="row">
                    <form id="cartForm{{ $index }}" method="POST" action="{{ route('add-to-cart-multiple-modal') }}">
                        @csrf
                            ...
                            @foreach ($get_barangs[$yek->id_usulan_barang] ?? [] as $rkbu)
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <span class="fa-sm"> Spesifikasi: {{ $rkbu->spek }}</span><br /><br />
                                        <span class="fa-sm badge bg-label-dark">{{ $rkbu->sumber_dana->nama_sumber_dana }}</span>
                                    </td>
