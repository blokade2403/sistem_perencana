            ...
            <div class="card-body">
                                        ...
                                        <div class="user-profile-info">
                                            ...
                                            <ul class="list-inline mb-0 d-flex align-items-center flex-wrap justify-content-sm-start justify-content-center gap-2">
                                                ...
                                                <div class="demo-inline-spacing">
                                                    ...
                                                    <a href="{{route('rkbu_modal_kantors.create')}}" class="btn rounded-pill btn-label-info waves-effect">
                                                    ...
                                                    <a href="{{route('rkbu_modal_kantors.downloadPDFModalKantor')}}" class="btn rounded-pill btn-label-warning waves-effect">
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                             <!-- Filter Form -->
                             <form action="{{ route('rkbu_modal_kantors.index') }}" method="GET">
                            ...
                            @foreach ($rkbus as $rkbus)
                                <tr>
                                    ...
                                    <td class="fs-14">
                                        ...
                                        <small>{{$rkbus->sub_kategori_rkbu->kode_sub_kategori_rkbu}}. {{$rkbus->sub_kategori_rkbu->nama_sub_kategori_rkbu}} <br /></small><p></p>
                                    ...
                                    <td class="fs-14">
                                        ...
                                        <small><span class="fa-sm">Penempatan : {{$rkbus->penempatan}}</span></small><br />
                                    ...
                                    <td class="py-2">
                                        ...
                                        @else
                                            <span class="fa-sm text-danger">Dok. KAP : Tidak Ada File KAP.</span><br />
                                        @endif
                                    ...
                                    <div class="demo-inline-spacing">
                                        <div class="d-flex justify-content-start align-items-center gap-2">
                                            @if ($rkbus->id_status_validasi == '9cfb1edc-2263-401f-b249-361db4017932' || session('status_edit') == 'tidak aktif')
                                            ...
                                            @else
                                            <a href="{{ route('rkbu_modal_kantors.edit', $rkbus->id_rkbu) }}" class="btn btn-icon btn-primary waves-effect" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-custom-class="tooltip-primary" data-bs-original-title="Edit Data">
                                                <span class="tf-icons mdi mdi-comment-edit"></span>
                                            </a>
                                            <a href="javascript:void(0);" onclick="showDetailRkbuBarjas('{{ $rkbus->id_rkbu }}')"  class="btn btn-icon btn-outline-info waves-effect" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-custom-class="tooltip-info" data-bs-original-title="Detail Data">
                                                <span class="tf-icons mdi mdi-file-document-alert-outline"></span>
                                            </a>
                                            <form action="{{route('rkbu_modal_kantors.destroy', $rkbus->id_rkbu)}}" method="POST" class="delete-form">
                                                @csrf
                                                @method('DELETE')
