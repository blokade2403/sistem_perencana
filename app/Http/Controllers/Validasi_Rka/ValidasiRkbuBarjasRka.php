...
class ValidasiRkbuBarjasRka extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view(
            'frontend.validasi_rka.barang_jasa.index',
            compact(
                'rkbus',
                'faseTahun',
                'total_anggaran',
    ...
    public function update(Request $request, $id)
    {
        ...
        // Redirect dengan pesan sukses
        return redirect()->route('validasi_barang_jasa_rkas.index')->with('success', 'Data berhasil diperbarui.');
    }
