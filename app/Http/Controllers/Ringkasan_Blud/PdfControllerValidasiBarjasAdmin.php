...
class PdfControllerValidasiBarjasAdmin extends Controller
{
    public function downloadPDF(Request $request)
    {
        ...
        $htmlBody = view('frontend.Ringkasan_Blud.barang_jasa.print_validasi_barjas_admin', compact('rkbus', 'tanggal_perencanaans', 'jabatan_kabag', 'nama_rumah_sakit', 'nama_pejabat', 'nip_pejabat_kabag', 'nip_direktur', 'nama_direktur', 'pdf', 'sub_kategori_rkbus', 'status_validasi_rka', 'total_anggaran', 'categories', 'namaProgram', 'namaKegiatan', 'namaSubKegiatan', 'kodeProgram', 'kodeKegiatan', 'kodeSubKegiatan'))->render();
