...
<div class="content-wrapper">
    <!-- Content -->
        ...
        <form id="confirmSubmitForm" class="needs-validation" method="POST" action="{{route('uraian_satus.update', $uraianSatu->id_uraian_2)}}">
            @csrf
            @method('PUT')
            <div class="col-xl-12">
                <div class="card-body">
                                        ...
                                        <div class="col-12 col-md-6">
                                            <div class="input-group input-group-merge">
                                                ...
                                                <div class="form-floating form-floating-outline">
                                                    <input type="text" class="form-control" name="nama_uraian_2" value="{{$uraianSatu->nama_uraian_2}}" id="basic-addon11" placeholder="John Doe" aria-label="uraian_satuname" aria-describedby="basic-addon11" />
