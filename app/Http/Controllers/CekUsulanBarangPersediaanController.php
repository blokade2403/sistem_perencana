...
class CekUsulanBarangPersediaanController extends Controller
{
    /**
    ...
    public function index()
    {
        ...
        return view('frontend.cek_usulan_barang_persediaan.index', compact('usulan_barangs'));
    }
    ...
    public function show(UsulanBarang $usulanBarang, $id_usulan_barang)
    {
        ...
        return view('frontend.cek_usulan_barang_persediaan.cek_usulan_invoice', $data, compact('sub_kategori_rkbus', 'usulan_barangs', 'id_usulan', 'invoice'));
    }
