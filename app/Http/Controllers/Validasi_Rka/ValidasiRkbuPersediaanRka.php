...
class ValidasiRkbuPersediaanRka extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $sub_kategori_rkbus = SubKategoriRkbu::join('rkbus', 'rkbus.id_sub_kategori_rkbu', '=', 'sub_kategori_rkbus.id_sub_kategori_rkbu')
            ...
            ->where('rkbus.nama_tahun_anggaran', $tahunAnggaran)
            ->where('jenis_kategori_rkbus.id_jenis_kategori_rkbu', '9cdfd364-2946-4ea1-bec2-e1130e8d9f2c') // Prefix dengan nama tabel
        ...
        return view('frontend.validasi_rka.persediaan.index', compact(
            'rkbus',
            'selisih',
            'jumlah_anggaran',
    ...
    public function update(Request $request, string $id)
    {
        ...
        return redirect()->route('validasi_persediaan_rkas.index')->with('success', 'Data berhasil diperbarui.');
    }
