...
@section('container')
    <div class="card-body">
                            ...
                            <table id="example" class="table table-striped" style="width:100%">
                                ...
                                <tbody>
                                    @php
                                            ...
                                            @include('frontend.partials.modal_komponen_usulan_spj_modal')
                                            </td>
                                            <td>
                                                <a href="{{ route('usulan_spj_modals.show', $key->id_spj )}}" class="btn btn-sm btn-info">
                                            ...
                                            <td>
                                                ...
                                                <form action="{{ route('usulan_spj_modals.destroy', $key->id_spj) }}" method="POST" class="delete-form">
                                                    @csrf
                                                    @method('DELETE')
        ...
        @include('frontend.partials.modal_usulan_spj_no_usulan_modal')
