...
<div class="content-wrapper">
    <!-- Content -->
        <form id="confirmSubmitForm" class="needs-validation" method="POST" action="{{route('kategori_upload_dokumens.update', $KategoriUploadDokumen->id_kategori_upload_dokumen)}}">
            @csrf
            @method('PUT')
            <div class="col-xl-12">
                <div class="card-body">
                                        ...
                                        <div class="col-12 col-md-4">
                                            <div class="input-group input-group-merge">
                                                ...
                                                <div class="form-floating form-floating-outline">
                                                    <input type="text" class="form-control" name="nama_kategori_upload_dokumen" value="{{$KategoriUploadDokumen->nama_kategori_upload_dokumen}}" id="basic-addon11" placeholder="John Doe" aria-label="tahun_anggaranname" aria-describedby="basic-addon11" />
