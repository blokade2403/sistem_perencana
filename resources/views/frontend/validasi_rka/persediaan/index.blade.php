...
@section('container')
        <!-- Content -->
            <div class="card-body">
                <!-- Header -->
                @include('frontend.partials.modal_upload')
                <div class="row">
                    <div class="col-12">
                                        ...
                                        <div class="user-profile-info">
                                            ...
                                            <ul class="list-inline mb-0 d-flex align-items-center flex-wrap justify-content-sm-start justify-content-center gap-2">
                                                ...
                                                <div class="demo-inline-spacing">
                                                    ...
                                                    @endif
                                                    <a href="{{route('validasi_persediaan_rkas.downloadPDF_ValidasipersediaanKabag')}}" class="btn rounded-pill btn-label-warning waves-effect">
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                             <!-- Filter Form -->
                             <form action="{{ route('validasi_persediaan_rkas.index') }}" method="GET">
                                @include('frontend.partials.filter_rkbu')
                            </form>
                            <form action="{{ route('validasi_persediaan_rkas.massValidasi') }}" method="POST">
                                @csrf
                                @if ($faseTahun && $faseTahun == 'Perencanaan')
                                ...
                                @foreach ($rkbus as $rkbus)
                                    ...
                                    <div class="demo-inline-spacing">
                                        <div class="d-flex justify-content-start align-items-center gap-2">
                                            @if ($faseTahun && $faseTahun !== 'Non Aktif')
                                            <a href="{{ route('validasi_persediaan_rkas.edit', $rkbus->id_rkbu) }}" class="btn btn-icon btn-primary waves-effect" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-custom-class="tooltip-primary" data-bs-original-title="Edit Data">
                                                <span class="tf-icons mdi mdi-comment-edit"></span>
                                            </a>
                                            @endif
                                            <a href="javascript:void(0);" onclick="showDetailRkbuPersediaan('{{ $rkbus->id_rkbu }}')"  class="btn btn-icon btn-outline-info waves-effect" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-custom-class="tooltip-info" data-bs-original-title="Detail Data">
                                                <span class="tf-icons mdi mdi-file-document-alert-outline"></span>
                                            </a>
                                            {{-- <form action="{{route('validasi_persediaan_rkas.destroy', $rkbus->id_rkbu)}}" method="POST" class="delete-form">
                                                @csrf
                                                @method('DELETE')
