                                    ...
                                    @php
                                            ...
                                            <td>
                                                <div class="demo-inline-spacing">
                                                    ...
                                                    <a href="{{ route('validasi_usul_persediaan_dirs.keranjang', $key->id_usulan_barang) }}" class="btn btn-icon btn-warning waves-effect waves-light">
                                                        <span class="tf-icon mdi mdi-account-alert-outline"></span>
                                                    </a>
                                                    ...
                                                    <a href="{{route('validasi_usul_persediaan_dirs.show', $key->id_usulan_barang)}}" class="btn btn-icon btn-primary waves-effect waves-light">
                                                        <span class="tf-icon mdi mdi-checkbox-marked-circle-outline"></span>
                                                    </a>
