    ...
    <div class="card-body">
        <!-- Header -->
                            ...
                            <div class="flex-grow-1 mt-3 mt-sm-5">
                                <div class="d-flex align-items-md-end align-items-sm-start align-items-center justify-content-md-between justify-content-start mx-4 flex-md-row flex-column gap-4">
                                    ...
                                    <div class="d-flex bg-label-primary p-3 border rounded my-3">
                                        <div class="border border-primary rounded me-3 p-2 d-flex align-items-center justify-content-center w-px-40 h-px-40">
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        <form action="{{ route('validasi_usulan_barangs.index') }}" method="GET">
                                            ...
                                            <td>
                                                <div class="d-flex align-items-center gap-2">
                                                    ...
                                                    @if ($key->usulanBarangDetails->isEmpty())
                                                        <form action="{{ route('validasi_usulan_barangs.delete', $key->id_usulan_barang) }}" method="POST" class="delete-form m-0">
                                                            @csrf
                                                            @method('DELETE')
                                                    ...
                                                    @if (session('nama_level_user') == 'Administrator')
                                                        @if ($key->status_permintaan_barang == 'Perlu Validasi Perencana')
                                                            <a href="{{ route('validasi_usulan_barangs.keranjang', $key->id_usulan_barang) }}" class="btn btn-icon btn-warning waves-effect waves-light">
                                                                <span class="tf-icon mdi mdi-account-alert-outline"></span>
                                                            </a>
                                                        @elseif ($key->status_validasi_perencana == 'Disetujui Perencana')
                                                            <a href="{{ route('validasi_usulan_barangs.show', $key->id_usulan_barang) }}" class="btn btn-icon btn-primary waves-effect waves-light">
