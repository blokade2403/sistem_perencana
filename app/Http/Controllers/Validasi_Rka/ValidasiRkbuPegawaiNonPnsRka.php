...
class ValidasiRkbuPegawaiNonPnsRka extends Controller
{
    /**
    ...
    public function index(Request $request)
    {
        ...
        return view('frontend.validasi_rka.pegawai_non_pns.index', compact(
            'rkbus',
            'total_anggaran',
            'sub_kategori_rkbus',
            'status_validasi_rka',
    ...
    public function edit(string $id)
    {
        ...
        return view('frontend.validasi_rka.pegawai_non_pns.edit', compact('pegawai', 'status_validasi', 'komponens', 'sub_kategori_rkbus', 'uraian_satu', 'uraian_dua'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        // Temukan data berdasarkan ID
        $data_sebelum = $RkbuPegawai->toArray();
        ...
        return redirect()->route('validasi_pegawai_non_pns_rkas.index')->with('success', 'Data berhasil diperbarui.');
    }
