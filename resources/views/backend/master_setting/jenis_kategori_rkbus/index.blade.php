    ...
    <!-- Content -->
                                        ...
                                        <div class="user-profile-info">
                                            ...
                                            <div class="btn-toolbar demo-inline-spacing" role="toolbar" aria-label="Toolbar with button groups">
                                                <div class="btn-group" role="group" aria-label="First group">
                                                    <a href="{{route('jenis_kategori_rkbus.create')}}" class="btn btn-outline-secondary btn-primary">
                    ...
                    <div class="card">
                        ...
                        <table id="example" class="table table-bordered" style="min-width: 845px">
                            <thead>
                                <tr>
                                    <th>No</th>
                                    <th>Kode Jenis Kategori RKBU</th>
                                    <th>Nama Jenis Kategori RKBU</th>
                                    <th>Action</th>
                                </tr>
                            </thead>
                            <tbody>
                                @if($jenis_kategori_rkbus->isEmpty())
        ...
        @else
                                <tr>
                                    ...
                                    <td>{{ $no++ }}</td>
                                    <td>{{ $key->kode_jenis_kategori_rkbu }}</td>
                                    <td>{{ $key->nama_jenis_kategori_rkbu }}</td>
                                        <td>
                                            <div class="btn-group" id="dropdown-icon-demo">
                                                ...
                                                <ul class="dropdown-menu">
                                                    <li>
                                                        <a href="{{ route('jenis_kategori_rkbus.edit', $key->id_jenis_kategori_rkbu) }}" class="dropdown-item d-flex align-items-center"><i class="mdi mdi-chevron-right scaleX-n1-rtl"></i>Edit</a>
                                                    </li>
                                                    <form action="{{ route('jenis_kategori_rkbus.destroy', $key->id_jenis_kategori_rkbu) }}" method="POST" class="delete-form">
                                                        @csrf
                                                        @method('DELETE')
