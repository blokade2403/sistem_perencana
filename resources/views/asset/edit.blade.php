...
<div class="content-wrapper">
    ...
    <div class="content-body">
            ...
            <div class="row">
                <div class="col-xl-12">
                    <div class="card-body">
                        <form id="confirmSubmitForm"  method="POST" action="{{route('barang_assets.update', $asset->id_asset)}}" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                            <div class="card mb-4">
                                            ...
                                            <div class="added-cards">
                                                ...
                                                <div class="cardMaster bg-lighter p-3 rounded mb-3">
                                                    <div class="d-flex justify-content-between flex-sm-row flex-column">
                                                        <div class="card-information me-2">
                                                            <div class="d-flex align-items-center mb-1 flex-wrap gap-2">
                                                                <h6 class="mb-0 me-2 fw-semibold">Upload SPTJM Asset : </h6>
                                                            </div>
                                                            <div class="mb-3">
                                                                <input class="form-control" type="file" name="upload_sptjm" id="formFileMultiple" multiple />
                                                            </div>
                                                        </div>
                                                        <div class="d-flex flex-column text-start text-lg-end">
                                                 ...
                                                 <div id="creditCardForm" class="row g-4">
                                                    <div class="col-12 col-md-6">
                                                        <div class="input-group input-group-merge">
                                                            <div class="form-floating form-floating-outline">
                                                                <input id="paymentCard" name="pengguna_asset" value="{{$asset->pengguna_asset}}" class="form-control bg-label-info credit-card-mask" placeholder="Nama Asset" type="text" aria-describedby="paymentCard2" />
                                                     ...
                                                     <div class="col-12 col-md-6">
                                                       <div class="input-group input-group-merge">
                                                            <div class="form-floating form-floating-outline">
                                                                <input id="paymentCard" name="nip_pengguna" value="{{$asset->nip_pengguna}}" class="form-control bg-label-info credit-card-mask" placeholder="NIP/NRK" type="text" aria-describedby="paymentCard2" />
                                                     ...
                                                     <div class="col-12 col-md-12">
                                                       <div class="input-group input-group-merge">
                                                            <div class="form-floating form-floating-outline">
                                                                <input id="paymentCard" name="jabatan_pengguna" value="{{$asset->jabatan_pengguna}}" class="form-control bg-label-info credit-card-mask" placeholder="Jabatan" type="text" aria-describedby="paymentCard2" />
