                    ...
                    <div class="row">
                        <div class="table-responsive mb-4 col-md-12 text-nowrap">
                            <table id="example" class="table table-striped">
                                ...
                                <span class="fa-xs">
                                    <a href="{{ route('usulan_barang_details.downloadReportExport', $no_inv->id_usulan_barang) }}" class="btn btn-xs rounded-pill btn-outline-secondary waves-effect">
                                    ...
                                    <tr>
                                        <td colspan="4" class="align-top px-4 py-3">
                                            ...
                                            <p class="mb-2">
                                                ...
                                                <span class="fa-xs">Tanggal Upload : </span>
                                        </td>
                                ...
                                <div class="row">
                                    <div class="col-md-4 m-3">
                                        <div class="demo-inline-spacing">
                                            <div class="mb-3">
                                                <a href="{{route('cek_usulan_barang_barjass.index')}}" class="btn btn-label-secondary">
                                                    Back
                                                </a>
