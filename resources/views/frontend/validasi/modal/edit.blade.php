...
<div class="content-wrapper">
    <!-- Content -->
        ...
        @endif
        <form class="needs-validation" action="{{ route('validasi_modals.update', $rkbuBarangJasa->id_rkbu) }}"  method="POST" id="confirmSubmitForm" enctype="multipart/form-data" validate>
            @csrf
            @method('PUT')
            <div class="col-xl-12">
                <div class="card-body">
                            ...
                            <div id="formAccountSettings">
                                <div class="row">
                                    ...
                                    <div class="mt-2">
                                        ...
                                        <a href="{{route('validasi_modals.index')}}" class="btn btn-outline-secondary">Kembali</a>
                                    </div>
                            </div>
                        </div>
                    </div>
