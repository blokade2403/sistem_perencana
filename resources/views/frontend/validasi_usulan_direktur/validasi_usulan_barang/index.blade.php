                            ...
                            <table id="example" class="table table-striped" style="width:100%">
                                ...
                                <tbody>
                                    @php
                                            ...
                                            <td>
                                                <div class="demo-inline-spacing">
                                                    @if (session('nama_level_user') == 'Direktur' && $key->status_permintaan_barang == 'Perlu Validasi Perencana') 
                                                    <a href="#" class="btn btn-icon btn-danger waves-effect waves-light">
                                                        <span class="tf-icon mdi mdi-account-alert-outline"></span>
                                                    </a>
                                                    @elseif (session('nama_level_user') == 'Direktur' && $key->status_permintaan_barang == 'Disetujui Perencana')
                                                    <a href="#" class="btn btn-icon btn-danger waves-effect waves-light">
                                                        <span class="tf-icon mdi mdi-account-alert-outline"></span>
                                                    </a>
                                                    @endif
                                                    @if (session('nama_level_user') == 'Validasi RKA' && $key->status_permintaan_barang == 'Disetujui Perencana') 
                                                    <a href="{{ route('validasi_usulan_barang_direkturs.keranjang', $key->id_usulan_barang) }}" class="btn btn-icon btn-warning waves-effect waves-light">
                                                        <span class="tf-icon mdi mdi-account-alert-outline"></span>
                                                    </a>
                                                    ...
                                                    <a href="#" class="btn btn-icon btn-primary waves-effect waves-light">
                                                        <span class="tf-icon mdi mdi-checkbox-marked-circle-outline"></span>
                                                    </a>
                                                    @endif
                                                    @if (session('nama_level_user') == 'Direktur' && $key->status_permintaan_barang == 'Validasi Kabag') 
                                                    <a href="{{ route('validasi_usulan_barang_direkturs.keranjang', $key->id_usulan_barang) }}" class="btn btn-icon btn-warning waves-effect waves-light">
                                                        <span class="tf-icon mdi mdi-account-alert-outline"></span>
                                                    </a>
                                                    @elseif (session('nama_level_user') == 'Direktur' && $key->status_permintaan_barang == 'Perlu Validasi Direktur')
                                                    <a href="#" class="btn btn-icon btn-danger waves-effect waves-light">
                                                        <span class="tf-icon mdi mdi-account-lock-outline"></span>
                                                    </a>
                                                    @elseif (session('nama_level_user') == 'Direktur' && $key->status_permintaan_barang == 'Validasi Direktur')
                                                    <a href="{{route('validasi_usulan_barang_direkturs.show', $key->id_usulan_barang)}}" class="btn btn-icon btn-primary waves-effect waves-light">
                                                        <span class="tf-icon mdi mdi-checkbox-marked-circle-outline"></span>
                                                    </a>
                                                    @elseif (session('nama_level_user') == 'Direktur' && $key->status_permintaan_barang == 'Di Tolak')
                                                    <a href="{{route('validasi_usulan_barang_direkturs.show', $key->id_usulan_barang)}}" class="btn btn-icon btn-primary waves-effect waves-light">
                                                        <span class="tf-icon mdi mdi-checkbox-marked-circle-outline"></span>
                                                    </a>
                                                    @endif
