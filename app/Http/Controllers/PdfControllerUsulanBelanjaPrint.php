...
class PdfControllerUsulanBelanjaPrint extends Controller
{
    public function downloadPDF(Request $request)
    {
        ...
        $htmlBody = view('backend.ringkasan.kertas_kerja.print_master_spj_usulan', compact('jabatan_kabag', 'total_anggaran_blud', 'categories1', 'nama_rumah_sakit', 'nama_pejabat', 'nip_pejabat_kabag', 'nip_direktur', 'nama_direktur', 'pdf', 'sub_kategori_rkbus',  'hierarchy', 'namaProgram', 'namaKegiatan', 'namaSubKegiatan', 'kodeProgram', 'kodeKegiatan', 'kodeSubKegiatan'))->render();
