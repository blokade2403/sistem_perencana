...
<div class="content-wrapper">
    <!-- Content -->
        ...
        @endif
        <form class="needs-validation" action="{{ route('validasi_barang_jasas.update', $rkbuBarangJasa->id_rkbu) }}"  method="POST" id="confirmSubmitForm" enctype="multipart/form-data" validate>
            @csrf
            @method('PUT')
            <div class="col-xl-12">
                <div class="card-body">
                                        ...
                                        <div class="col-6 col-md-12 mb-4">
                                            <div class="form-floating form-floating-outline">
                                                ...
                                                <div class="form-floating mt-3">
                                                    <input type="hidden" id="id_sub_kategori_rekening" name="id_sub_kategori_rekening" value="{{$rkbuBarangJasa->id_sub_kategori_rekening}}" class="form-control" placeholder="Jenis Belanja">
                            ...
                            <div id="formAccountSettings">
                                <div class="row">
                                    ...
                                    <div class="mt-2">
                                        ...
                                        <a href="{{route('validasi_barang_jasas.index')}}" class="btn btn-outline-secondary">Kembali</a>
                                    </div>
                            </div>
                        </div>
                    </div>
