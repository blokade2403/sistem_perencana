    ...
    <div class="info">
        <table border="0" cellpadding="1" width="100%">
            ...
            <tr bgcolor="#ffffff">
                ...
                <th  width="15%" align="center"><h4>-</h4></th>
    ...
    <table class="table-data">
        <thead>
            <tr class="text-center">
                ...
                <th width="15%" rowspan="2">Uraian</th>
                <th width="6%" rowspan="2">Jumlah Anggaran</th>
                <th width="68%">Realisasi</th>
            </tr>
            <tr class="text-center">
                <th width="5%">Jan</th>
                <th width="5%">Feb</th>
        ...
        <tbody>
            ...
            @foreach ($categories1 as $jenisBelanja)
                                    <tr class="jenis">
                                        <td colspan="2" width="27%" class="fs-14">
                                ...
                                @foreach ($jenisBelanja->jenis_kategori_rkbus as $JenisKategori)
                                        <tr class="kategori mb-1 mt-1">
                                            ...
                                            <th colspan="2" width="23%">{{ $JenisKategori->kode_jenis_kategori_rkbu }}. {{ $JenisKategori->nama_jenis_kategori_rkbu }}</th>
                                            <td style="text-align: right;" width="6%">
                                    ...
                                    @foreach ($JenisKategori->obyek_belanjas as $ObyekBelanja)
                                        @foreach ($ObyekBelanja->kategori_rkbus as $KategoriRkbu)
                                            <tr class="mb-1 mt-1">
                                                <td width="2%"></td>
                                                <td width="2%"></td>
                                                <td width="2%" class="text-center">{{$no_child++}}</td>
                                                <th colspan="2" width="21%">{{ $KategoriRkbu->kode_kategori_rkbu }}. {{ $KategoriRkbu->nama_kategori_rkbu }}</th>
                                                <td style="text-align: right;" width="6%">
                                        ...
                                        @foreach ($KategoriRkbu->sub_kategori_rkbus as $SubKategoriRkbu)
                                            <tr>
                                                ...
                                                <td width="2%"></td>
                                                <td width="2%"></td>
                                                <th class="text-left fa-14" width="21%">{{ $SubKategoriRkbu->kode_sub_kategori_rkbu }}. {{ $SubKategoriRkbu->nama_sub_kategori_rkbu }}</th>
                                                <td style="text-align: right;" width="6%">
