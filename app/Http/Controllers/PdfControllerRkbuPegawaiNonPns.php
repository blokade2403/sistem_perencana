...
class PdfControllerRkbuPegawaiNonPns extends Controller
{
    public function downloadPDF(Request $request)
    {
        ...
        })->where('id_sub_kategori_rkbu', '9d03d062-b7d6-490e-ad71-10d92c5628cb')->get();
        ...
        $total_anggaran = Rkbu::where('id_user', $id_user)
            ...
            ->whereHas('subKategoriRkbu.kategori_rkbu.obyek_belanja.jenis_kategori_rkbu', function ($query) {
                ...
                $query->where('id_jenis_belanja', '9cdfd042-e7cc-4008-ad0e-96d0a5452721')
        ...
        $categories = JenisBelanja::whereHas('jenis_kategori_rkbus.obyek_belanjas.kategori_rkbus.sub_kategori_rkbus.rkbus', function ($query) use ($id_user, $tahunAnggaran) {
            ...
            ->where('id_jenis_belanja', '9cdfd042-e7cc-4008-ad0e-96d0a5452721') // Filter pada jenis belanja tertentu
            ->whereHas('jenis_kategori_rkbus', function ($query) {
                $query->where('id_jenis_kategori_rkbu', '9cdfd354-e43a-4461-9747-e15fb74038ac'); // Filter pada jenis kategori rkbu tertentu
            })
            ->get();
