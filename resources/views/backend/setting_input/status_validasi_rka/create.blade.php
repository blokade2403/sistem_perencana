...
<div class="content-wrapper">
    ...
    <form id="confirmSubmitForm" class="needs-validation" method="POST" action="{{ route('status_validasi_rkas.store') }}">
        @csrf
        <div class="col-xl-12">
            <div class="card-body">
                <div class="card mb-4">
                                    ...
                                    <div class="col-12 col-md-6">
                                        <div class="input-group input-group-merge">
                                            ...
                                            <div class="form-floating form-floating-outline">
                                                <input type="text" class="form-control" name="nama_validasi_rka" id="basic-addon11" placeholder="John Doe" aria-label="uraian_satuname" aria-describedby="basic-addon11" />
