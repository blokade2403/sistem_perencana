                                        ...
                                        <div class="col-md-6 mb-3">
                                            <div class="col-12 mb-3">
                                                <div class="input-group input-group-merge">
                                                    <div class="form-floating form-floating-outline">
                                                        <input id="paymentCard" name="nama_asset" class="form-control credit-card-mask" placeholder="Nama Asset" type="text" aria-describedby="paymentCard2" />
                                            ...
                                            <div id="creditCardForm" class="row g-4">
                                                <div class="col-12 col-md-6 mb-3">
                                                    <div class="form-floating form-floating-outline">
                                                        <input type="text" name="kode_asset" id="paymentName" class="form-control" placeholder="Kode Barang" />
                                                ...
                                                <div class="col-12 col-md-6 mb-3">
                                                    <div class="form-floating form-floating-outline">
                                                        <div class="form-floating form-floating-outline">
                                                            <input type="text" name="no_register" id="paymentExpiryDate" class="form-control expiry-date-mask" placeholder="MM/YY" />
                                            ...
                                            <div class="added-cards">
                                                        ...
                                                        <div class="card-information me-2">
                                                            ...
                                                            <div class="input-group input-group-floating">
                                                                ...
                                                                <div class="form-floating">
                                                                    <input id="harga_barang" name="serial_number" onkeyup="sum();" class="form-control bg-lighter" id="basic-addon21" aria-label="Username" aria-describedby="basic-addon21" />
                                                ...
                                                <div id="creditCardForm" class="row g-4">
                                                    <div class="col-12 col-md-6">
                                                        <div class="input-group input-group-merge">
                                                            <div class="form-floating form-floating-outline">
                                                                <input id="paymentCard" name="pengguna_asset" class="form-control bg-label-info credit-card-mask" placeholder="Nama Asset" type="text" aria-describedby="paymentCard2" />
                                                     ...
                                                     <div class="col-12 col-md-6">
                                                       <div class="input-group input-group-merge">
                                                            <div class="form-floating form-floating-outline">
                                                                <input id="paymentCard" name="nip_pengguna" class="form-control bg-label-info credit-card-mask" placeholder="NIP/NRK" type="text" aria-describedby="paymentCard2" />
                                                                <label for="basic-addon21">NIP/NRK</label>
                                                            </div>
                                                        </div>
                                                    </div>
                                                     <div class="col-12 col-md-12">
                                                       <div class="input-group input-group-merge">
                                                            <div class="form-floating form-floating-outline">
                                                                <input id="paymentCard" name="jabatan_pengguna" class="form-control bg-label-info credit-card-mask" placeholder="Jabatan" type="text" aria-describedby="paymentCard2" />
                                                                <label for="basic-addon21">Jabatan</label>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div id="creditCardForm" class="row g-4">
                                                <div class="col-12 col-md-6">
                                                    <div class="form-floating form-floating-outline">
                                                        <input type="text" name="type" class="form-control" placeholder="John Doe" />
                                                ...
                                                <div class="col-12 col-md-6">
                                                    <div class="form-floating form-floating-outline">
                                                        <input type="text" id="vol2" name="merk" class="form-control" placeholder="merk" />
                                                        <label for="paymentName">Merk</label>
                                                    </div>
                                                </div>
                                                <div class="col-12 col-md-6">
                                                    <div class="form-floating form-floating-outline">
                                                        <input type="text" name="tahun_perolehan" class="form-control" placeholder="Tahun Perolehan" />
                                                ...
                                                <div class="col-12">
                                                    ...
                                                    <div class="form-floating form-floating-outline">
                                                        ...
                                                        <label for="floatingSelect">Kondisi Asset</label>
                                                    </div>
                                                    <hr>
                                                </div>
                                            ...
                                            <div id="creditCardForm" class="row g-4">
                                                        ...
                                                        <div class="d-flex justify-content-between flex-sm-row flex-column">
                                                            <div class="card-information me-2">
                                                                ...
                                                                <div class="input-group input-group-floating">
                                                                    ...
                                                                    <div class="form-floating">
                                                                        <input id="harga_barang" name="harga_asset" onkeyup="sum();" class="form-control bg-lighter" id="basic-addon21" aria-label="Username" aria-describedby="basic-addon21" />
                                                ...
                                                <div class="col-12 col-md-4">
                                                    <div class="form-floating form-floating-outline">
                                                        <div class="input-group input-group-merge">
                                                            ...
                                                            <div class="form-floating form-floating-outline">
                                                                <input type="number" step="1" min="0" max="100" class="form-control" name="jumlah_asset" aria-label="Amount (to the nearest dollar)" />
                                                                <label>Jumlah</label>
                                                            </div>
                                                ...
                                                <div class="col-6 col-md-12">
                                                    <div class="input-group input-group-merge">
                                                        ...
                                                        <div class="form-floating form-floating-outline">
                                                            <input type="text" name="status_asset" class="form-control" aria-label="Amount (to the nearest dollar)" />
                                                            <label>Status</label>
                                                        </div>
                                                        <span class="input-group-text"></span>
                                                    </div>
