...
class PdfControllerSpjBastPK extends Controller
{
    public function downloadPDF($id = null)
    {
        ...
        $tanggal1 = Carbon::parse($keranjang->isNotEmpty() ? ($keranjang->first()->tgl_surat_pesanan) : null);
        $tanggal2 = Carbon::parse($keranjang->isNotEmpty() ? ($keranjang->first()->jangka_waktu_pekerjaan) : null);
        $selisih_hari = $tanggal2->diffInDays($tanggal1);

        $jumlah_hari =  $selisih_hari;
        $jumlah_hari_terbilang = terbilang($jumlah_hari + 1);

        $rincian_belanja_convert    = $keranjang->isNotEmpty() ? ($keranjang->first()->rincian_belanja) : null;

        $tgl_surat_pesanan      = $keranjang->isNotEmpty() ? formatTanggal($keranjang->first()->tgl_surat_pesanan) : null;
        $tgl_waktu_pekerjaan    = $keranjang->isNotEmpty() ? formatTanggal($keranjang->first()->jangka_waktu_pekerjaan) : null;

        $tgl_pesanan            = $tgl_surat_pesanan ? $tgl_surat_pesanan : 'Tanggal tidak tersedia';
        $tgl_pekerjaan          = $tgl_waktu_pekerjaan ? $tgl_waktu_pekerjaan : 'Tanggal tidak tersedia';
        $terbilang_total        = terbilangUang($sum_total_anggaran_usulan_barang);
        ...
        $data = [
            ...
            'rincian_belanja_convert'         => $rincian_belanja_convert,
        ...
        $htmlBody = view('backend.pengadaan.master_spj.print_bast_pk', $data, compact('nama_direktur', 'nip_direktur', 'nama', 'alamat', 'email', 'tlp'));
        ...
        $htmlSignatureTable = '
             <table>
                <tr>
                    <td style="font-weight: normal; margin-left: 50px; font-size: 10px; line-height: 1.5; text-align: center;" class="no-border" width="25%">Hormat kami,</td>
                    <td style="font-weight: normal; margin-left: 50px; font-size: 10px; line-height: 1.5; text-align: center;" class="no-border" width="30%"></td>
                    <td style="font-weight: normal; margin-left: 50px; font-size: 10px; line-height: 1.5; text-align: left;" class="no-border" width="20%"></td>
                    <td style="font-weight: normal; margin-left: 50px; font-size: 10px; line-height: 1.5; text-align: center;" class="no-border" width="25%"></td>
                </tr>
                <tr>
                    <td style="font-weight: normal; margin-left: 50px; font-size: 10px; line-height: 1; text-align: center;" class="no-border" width="25%">Pelaksana Pekerjaan</td>
                    <td style="font-weight: normal; margin-left: 50px; font-size: 10px; line-height: 1; text-align: center;" class="no-border" width="30%">Pejabat Pembuat Komitmen</td>
                    <td style="font-weight: normal; margin-left: 50px; font-size: 10px; line-height: 1; text-align: center; text:wrap" class="no-border" colspan="2" width="45%">Tim Pendukung Pengadaan Barang dan Jasa</td>
                </tr>
                <tr>
                    <td style="font-weight: normal; margin-left: 50px; font-size: 10px; line-height: 1.5; text-align: center;" class="no-border" width="25%">' . $detail_master_spj->nama_perusahaan . '</td>
                    <td style="font-weight: normal; margin-left: 50px; font-size: 10px; line-height: 1.5; text-align: center;" class="no-border" width="30%">RSUD Cilincing</td>
                    <td style="font-weight: normal; margin-left: 50px; font-size: 10px; line-height: 1.5; text-align: center; text:wrap" class="no-border" width="45%" colspan="2">RSUD Cilincing</td>
                </tr>
                <tr>
                    <td style="font-weight: normal; margin-left: 50px; font-size: 10px; line-height: 5; text-align: center;" class="no-border" width="25%"></td>
                    <td style="font-weight: normal; margin-left: 50px; font-size: 10px; line-height: 5; text-align: center;" class="no-border" width="30%"></td>
                    <td style="font-weight: normal; margin-left: 50px; font-size: 10px; line-height: 5; text-align: left;" class="no-border" width="20%">Nama</td>
                    <td style="font-weight: normal; margin-left: 50px; font-size: 10px; line-height: 5; text-align: center; text:wrap" class="no-border" width="25%">Tanda Tangan</td>
                </tr>
                <tr>
                    <td style="font-weight: normal; margin-left: 50px; font-size: 10px; line-height: 0; text-align: center;" class="no-border" width="25%">' . $detail_master_spj->nama_direktur_perusahaan . '</td>
                    <td style="font-weight: normal; margin-left: 50px; font-size: 10px; line-height: 0; text-align: center;" class="no-border" width="30%">' . $detail_master_spj->nama_ppk . '</td>
                    <td style="font-weight: normal; margin-left: 50px; font-size: 10px; line-height: 0; text-align: left;" class="no-border" width="20%">' . $master_spj->adminPendukung->nama_pendukung_ppk . '</td>
                    <td style="font-weight: normal; margin-left: 50px; font-size: 10px; line-height: 0; text-align: center; text:wrap" class="no-border" width="25%">(___________)</td>
                </tr>
                 <tr>
                    <td style="font-weight: normal; margin-left: 50px; font-size: 10px; line-height: 2; text-align: center;" class="no-border" width="25%">' . $detail_master_spj->jabatan_perusahaan . '</td>
                    <td style="font-weight: normal; margin-left: 50px; font-size: 10px; line-height: 2; text-align: center;" class="no-border" width="30%">NIP ' . $detail_master_spj->nip_ppk . '</td>
                    <td style="font-weight: normal; margin-left: 50px; font-size: 10px; line-height: 2; text-align: left;" class="no-border" width="20%"></td>
                    <td style="font-weight: normal; margin-left: 50px; font-size: 10px; line-height: 2; text-align: center; text:wrap" class="no-border" width="25%"></td>
                </tr>
