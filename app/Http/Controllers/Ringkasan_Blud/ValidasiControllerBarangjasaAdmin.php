...
use App\DataTables\ValidasiControllerBarangJasaAdminDataTable;

class ValidasiControllerBarangjasaAdmin extends Controller
{

    public function index(ValidasiControllerBarangJasaAdminDataTable $dataTable, Request $request)
    {
        ...
        return $dataTable->render('frontend.Ringkasan_Blud.barang_jasa.index', [
    ...
    public function edit(string $id)
    {
        ...
        return view('frontend.Ringkasan_Blud.barang_jasa.edit', compact('rkbuBarangJasa', 'user', 'rekening_belanja', 'status_validasi_rka', 'status_validasi', 'komponens', 'sub_kategori_rkbus', 'uraian_satu', 'uraian_dua'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        // Redirect dengan pesan sukses
        return redirect()->route('validasi_barang_jasa_admins.index')->with('success', 'Data berhasil diperbarui.');
    }
