 ...
 <div class="modal fade" id="referAndEarnModal" tabindex="-1" aria-hidden="true">
        ...
        <div class="modal-content p-3 p-md-5">
            <div class="modal-body pt-3 pt-md-0 px-0 pb-md-0">
                ...
                <div class="text-center mb-4">
                    <h3 class="mb-2">Form Permintaan Barang Modal</h3>
                ...
                <form class="row g-3" method="POST" action="{{ route('usulan_barang_modals.store') }}">
                    @csrf
                    <div class="col-lg-10">
