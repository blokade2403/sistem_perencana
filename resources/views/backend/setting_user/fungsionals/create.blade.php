...
<div class="content-wrapper">
    <!-- Content -->
        <form class="needs-validation" method="POST" action="{{route(('fungsionals.store'))}}">
            @csrf
            <div class="col-xl-12">
                <div class="card-body">
                    <div class="card mb-4">
                        ...
                        <div class="card-body pt-1">
                            <div class="row">
                                        ...
                                        <div class="col-12 col-md-12">
                                            <div class="input-group input-group-merge">
                                                ...
                                                <div class="form-floating form-floating-outline">
                                                    <input type="text" class="form-control" name="jabatan_fungsional" id="basic-addon11" placeholder="John Doe" aria-label="jabatan-name" aria-describedby="basic-addon11" />
                                                    <label for="basic-addon11">Nama Jabatan Fungsional</label>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="mt-2">
                                    ...
                                    <a href="/fungsionals" class="btn btn-outline-secondary">Back</a>
                                </div>
                            </div>
                        </div>
