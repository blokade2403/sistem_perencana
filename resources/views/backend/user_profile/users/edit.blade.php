...
@section('container')
    <!-- Content -->
            <form class="needs-validation" method="POST" action="{{route('users.update', $user->id_user)}}">
                @csrf
                @method('PUT')
                <div class="col-xl-12">
                    <div class="card-body">
                                        ...
                                        <div id="creditCardForm" class="row g-4">
                                            <div class="col-12 col-md-6">
                                                <div class="input-group input-group-merge">
                                                    ...
                                                    <div class="form-floating form-floating-outline">
                                                        <input type="text" class="form-control" name="username" value="{{$user->username}}" id="basic-addon11" placeholder="John Doe" aria-label="Username" aria-describedby="basic-addon11" />
                                            ...
                                            <div class="col-12 col-md-6">
                                                <div class="input-group input-group-merge">
                                                    <span class="input-group-text"> <i class="mdi mdi-account me-2"></i></span>
                                                    <div class="form-floating form-floating-outline">
                                                        <input type="text" class="form-control" name="nama_lengkap" value="{{$user->nama_lengkap}}" id="basic-addon11" placeholder="John Doe" aria-label="Username" aria-describedby="basic-addon11" />
                                            ...
                                            <div class="col-12 col-md-6">
                                                <div class="input-group input-group-merge">
                                                    ...
                                                    <div class="form-floating form-floating-outline">
                                                        <input type="text" class="form-control" name="email" value="{{$user->email}}" id="basic-addon11" placeholder="John Doe" aria-label="Username" aria-describedby="basic-addon11" />
                                            ...
                                            <div class="col-12 col-md-12">
                                                <div class="input-group input-group-merge">
                                                    ...
                                                    <div class="form-floating form-floating-outline">
                                                        <input type="password" class="form-control" name="password" id="basic-addon11" placeholder="John Doe" aria-label="Username" aria-describedby="basic-addon11" />
                                                    ...
                                                    <div class="input-group input-group-merge">
                                                        <div class="form-floating form-floating-outline">
                                                            <select name="id_admin_pendukung_ppk" class="select2 form-select form-select-lg" data-allow-clear="true">
                                                                <option value="{{$user->id_admin_pendukung_ppk}}">{{$user->nama_pendukung_ppk}}</option>
                                                ...
                                                <div class="input-group input-group-merge">
                                                    <div class="form-floating form-floating-outline">
                                                        <select name="id_level" class="select2 form-select form-select-lg" data-allow-clear="true">
                                                            <option value="{{$user->id_level}}">{{$user->levelUser->nama_level_user}}</option>
                                                ...
                                                <div class="input-group input-group-merge">
                                                    <div class="form-floating form-floating-outline">
                                                        <select name="id_fase" class="select2 form-select form-select-lg" data-allow-clear="true">
                                                            <option value="{{$user->id_fase}}">{{$user->fase->nama_fase}}</option>
                                                ...
                                                <div class="input-group input-group-merge">
                                                    <div class="form-floating form-floating-outline">
                                                        <select name="id_unit" class="select2 form-select form-select-lg" data-allow-clear="true">
                                                            <option value="{{$user->id_unit}}">{{$user->unit->nama_unit}}</option>
                                                ...
                                                <div class="input-group input-group-merge">
                                                    <div class="form-floating form-floating-outline">
                                                        <select name="id_pejabat" class="select2 form-select form-select-lg" data-allow-clear="true">
                                                            <option value="{{$user->id_pejabat}}">{{$user->pejabat->nama_pejabat}}</option>
                                                ...
                                                <div class="input-group input-group-merge">
                                                    <div class="form-floating form-floating-outline">
                                                        <select name="id_ksp" class="select2 form-select form-select-lg" data-allow-clear="true">
                                                            <option value="{{$user->id_ksp}}">{{$user->ksp->nama_ksp}}</option>
