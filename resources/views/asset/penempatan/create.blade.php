...
<div class="content-wrapper">
    <!-- Content -->
        <form id="confirmSubmitForm" class="needs-validation" method="POST" action="{{route(('penempatans.store'))}}">
            @csrf
            <div class="col-xl-12">
                <div class="card-body">
                    <div class="card mb-4">
                            ...
                            <div class="row">
                                        ...
                                        <div class="col-12 col-md-6">
                                            <div class="input-group input-group-merge">
                                                ...
                                                <div class="form-floating form-floating-outline">
                                                    <input type="text" class="form-control" name="lokasi_barang" id="basic-addon11" placeholder="John Doe" aria-label="tahun_anggaranname" aria-describedby="basic-addon11" />
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <div class="col-12 col-md-12">
                                        <div class="input-group input-group-merge">
                                            <div class="form-floating form-floating-outline">
                                                <input type="text" class="form-control" name="penanggung_jawab" id="basic-addon11" placeholder="Budi" aria-label="Penanggung Jawab" aria-describedby="basic-addon11" />
                                ...
                                <div class="mt-2">
                                    ...
                                    <a href="/penempatans" class="btn btn-outline-secondary">Back</a>
                                </div>
                            </div>
                        </div>
