...
<div class="content-wrapper">
    <!-- Content -->
        ...
        @endif
        <form class="needs-validation" action="{{ route('rkbu_barang_jasas.update', $rkbuBarangJasa->id_rkbu) }}"  method="POST" id="confirmSubmitForm" enctype="multipart/form-data" validate>
            @csrf
            @method('PUT')
            <div class="col-xl-12">
                <div class="card-body">
