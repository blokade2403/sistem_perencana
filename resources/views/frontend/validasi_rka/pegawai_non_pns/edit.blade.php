...
<div class="content-wrapper">
    <!-- Content -->
        ...
        @endif
        <form class="needs-validation" action="{{route('validasi_pegawai_non_pns_rkas.update', $pegawai->id_rkbu)}}"  method="POST" id="confirmSubmitForm" enctype="multipart/form-data" validate>
            @csrf
            @method('PUT')
            <div class="col-xl-12">
                <div class="card-body">
                    ...
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            ...
                            <div class="mt-2">
                                ...
                                <a href="{{route('validasi_pegawai_non_pns_rkas.index')}}" class="btn btn-outline-secondary">Kembali</a>
                            </div>
                        </div>
                    </div>
                </div>
