            ...
            <div class="card-body">
                                        ...
                                        <div class="user-profile-info">
                                            ...
                                            <ul class="list-inline mb-0 d-flex align-items-center flex-wrap justify-content-sm-start justify-content-center gap-2">
                                                ...
                                                <div class="demo-inline-spacing">
                                                    ...
                                                    @endif
                                                    <a href="{{route('validasi_modals.downloadPDF_ValidasiModalKsp')}}" class="btn rounded-pill btn-label-warning waves-effect">
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                             <!-- Filter Form -->
                             <form action="{{ route('validasi_modals.index') }}" method="GET">
                                ...
                                <tr>
                                    ...
                                    <div class="demo-inline-spacing">
                                        <div class="d-flex justify-content-start align-items-center gap-2">
                                            ...
                                            @else
                                            <a href="{{ route('validasi_modals.edit', $rkbus->id_rkbu) }}" class="btn btn-icon btn-primary waves-effect" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-custom-class="tooltip-primary" data-bs-original-title="Edit Data">
                                                <span class="tf-icons mdi mdi-comment-edit"></span>
                                            </a>
                                            <a href="javascript:void(0);" onclick="showDetailRkbuBarjas('{{ $rkbus->id_rkbu }}')"  class="btn btn-icon btn-outline-info waves-effect" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-custom-class="tooltip-info" data-bs-original-title="Detail Data">
                                                <span class="tf-icons mdi mdi-file-document-alert-outline"></span>
                                            </a>
                                            <form action="{{route('validasi_modals.destroy', $rkbus->id_rkbu)}}" method="POST" class="delete-form">
                                                @csrf
                                                @method('DELETE')
