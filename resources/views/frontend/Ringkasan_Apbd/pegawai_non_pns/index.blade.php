                                        ...
                                        <div class="user-profile-info">
                                            ...
                                            <ul class="list-inline mb-0 d-flex align-items-center flex-wrap justify-content-sm-start justify-content-center gap-2">
                                                ...
                                                <div class="demo-inline-spacing">
                                                    <a href="{{route('validasi_non_pns_apbd_admins.create')}}" class="btn rounded-pill btn-label-info waves-effect">
                                                    ...
                                                    @endif
                                                    <a href="{{route('validasi_non_pns_apbd_admins.downloadPDF_ValidasiNonPnsApbdAdmin')}}" class="btn rounded-pill btn-label-warning waves-effect">
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                             <!-- Filter Form -->
                        <!-- view file -->
                        <form action="{{ route('validasi_non_pns_apbd_admins.index') }}" method="GET">
                    ...
                    <div class="demo-inline-spacing">
                        <div class="d-flex justify-content-start align-items-center gap-2">
                            <a href="{{ route('validasi_non_pns_apbd_admins.edit', $rkbus->id_rkbu) }}" class="btn btn-icon btn-primary waves-effect" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-custom-class="tooltip-primary" data-bs-original-title="Edit Data">
                            ...
                            <form action="{{route('validasi_non_pns_apbd_admins.destroy', $rkbus->id_rkbu)}}" method="POST" class="delete-form">
                                @csrf
                                @method('DELETE')
