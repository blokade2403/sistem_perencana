...
<div class="content-wrapper">
    <!-- Content -->
        ...
        @endif
        <form class="needs-validation" action="{{ route('validasi_modal_rkas.update', $rkbuBarangJasa->id_rkbu) }}"  method="POST" id="confirmSubmitForm" enctype="multipart/form-data" validate>
            @csrf
            @method('PUT')
            <div class="col-xl-12">
                <div class="card-body">
                                        ...
                                        <div class="col-6 col-md-12 mb-4">
                                            <div class="form-floating form-floating-outline">
                                                ...
                                                <div class="form-floating mt-3">
                                                    ...
                                                    <input type="text" id="id_kode_rekening_belanja" name="id_kode_rekening_belanja" value="{{$rkbuBarangJasa->id_kode_rekening_belanja}}" class="form-control" placeholder="ID Kategori RKBU" readonly>
                                                </div>
                                ...
                                <div class="col-12 col-md-6">
                                    <div class="form-floating form-floating-outline">
                                         @if ($total_anggaran_sebelumnya != $sisa_anggaran_sebelumnya)
                                            <input type="hidden" name="id_status_validasi_rka" value="{{ $rkbuBarangJasa->id_status_validasi_rka }}">
                                        @endif
                            ...
                            <div id="formAccountSettings">
                                <div class="row">
                                    ...
                                    <div class="mt-2">
                                        ...
                                        <button type="button" class="btn btn-primary me-2" data-bs-toggle="modal" data-bs-target="#onboardImageModal" onclick="saveChanges()">Save changes</button>
                                        <a href="{{route('validasi_modal_rkas.index')}}" class="btn btn-outline-secondary">Kembali</a>
                                        @else
