...
<div class="content-wrapper">
    <!-- Content -->
        ...
        @endif
        <form class="needs-validation" action="{{route('rkbu_modal_kantors.store')}}"  method="POST" id="confirmSubmitForm" enctype="multipart/form-data" validate>
            @csrf
            <div class="col-xl-12">
                <div class="card-body">
                    <div class="card mb-4">
                                                ...
                                                <div class="input-group input-group-merge">
                                                    <div class="input-group input-group-floating">
                                                        ...
                                                        <div class="form-floating">
                                                            <input type="number" name="standar_kebutuhan" class="form-control bg-lighter" id="basic-addon21" aria-label="Username" aria-describedby="basic-addon21" />
                                            ...
                                            <div class="form-floating form-floating-outline">
                                                <div class="input-group input-group-merge">
                                                    <div class="input-group input-group-floating">
                                                        ...
                                                        <div class="form-floating">
                                                            <input type="number" name="eksisting" class="form-control bg-lighter" id="basic-addon21" aria-label="Username" aria-describedby="basic-addon21" />
                                                ...
                                                <div class="d-flex justify-content-between flex-sm-row flex-column">
                                                    <div class="card-information me-2">
                                                        ...
                                                        <div class="input-group input-group-floating">
                                                            ...
                                                            <div class="form-floating">
                                                                <input type="number" name="kondisi_baik" class="form-control bg-lighter" id="basic-addon21" aria-label="Username" aria-describedby="basic-addon21" />
                                                    ...
                                                    <div class="card-information me-2">
                                                        ...
                                                        <div class="input-group input-group-floating">
                                                            <span class="input-group-text bg-lighter">Qty</span>
                                                            <div class="form-floating">
                                                                <input type="number" name="kondisi_rusak_berat" class="form-control bg-lighter" id="basic-addon21" aria-label="Username" aria-describedby="basic-addon21" />
                                        ...
                                        <div class="col-6 col-md-12 mb-4">
                                            <div class="form-floating form-floating-outline">
                                                ...
                                                <div class="form-floating mt-3">
                                                    <input type="text" id="id_sub_kategori_rekening" name="id_sub_kategori_rekening" class="form-control" placeholder="Jenis Belanja">
                            ...
                            <div id="formAccountSettings">
                                <div class="row">
                                    ...
                                    <div class="mt-2">
                                        ...
                                        <a href="{{route('rkbu_modal_kantors.index')}}" class="btn btn-outline-secondary">Kembali</a>
                                    </div>
                            </div>
                        </div>
                    </div>
