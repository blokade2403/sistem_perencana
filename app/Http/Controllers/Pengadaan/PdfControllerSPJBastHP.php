...
class PdfControllerSPJBastHP extends Controller
{
    public function downloadPDF($id = null)
    {
        ...
        $pengurus_barang = PejabatPengadaan::all();
        ...
        $htmlBody = view('backend.pengadaan.master_spj.print_bast_hp', $data, compact('nama_direktur', 'nip_direktur', 'nama', 'alamat', 'email', 'tlp'));
