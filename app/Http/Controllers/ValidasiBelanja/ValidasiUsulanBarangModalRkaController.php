...
class ValidasiUsulanBarangModalRkaController extends Controller
{
    /**
    ...
    public function index($id_sub_kategori_rkbu = null)
    {
        ...
        $id_usulan = UsulanBarang::join('users', 'usulan_barangs.id_user', '=', 'users.id_user')
            ...
            ->select('usulan_barangs.*') // Ambil detail barang juga jika diperlukan
        ...
        return view('frontend.validasi_usulan_rka.validasi_usulan_barang_modal.index', compact('usulan_barangs', 'get_barangs', 'id_usulan', 'sub_kategori_rkbus'));
    }
    ...
    public function updateValidasi(Request $request, $no_usulan_barang)
    {
        ...
        return redirect()->route('validasi_usulan_barang_modal_rkas.index')
    ...
    public function keranjang($id_usulan_barang)
    {
        ...
        return view('frontend.validasi_usulan_rka.validasi_usulan_barang_modal.keranjang', $data);
    }
