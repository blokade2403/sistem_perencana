...
class ValidasiControllerPegawaiNonPnsApbdAdmin extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $sub_kategori_rkbus = SubKategoriRkbu::join('rkbus', 'rkbus.id_sub_kategori_rkbu', '=', 'sub_kategori_rkbus.id_sub_kategori_rkbu')
            ...
            ->where('sub_kategori_rkbus.id_sub_kategori_rkbu', '!=', '9d03d062-b9b4-47ca-bda1-6bda8a3c4885')
        ...
        $query = Rkbu::join('users', 'rkbus.id_user', '=', 'users.id_user')
            ...
            ->join('sub_kegiatans', 'sub_kegiatans.id_sub_kegiatan', '=', 'aktivitas.id_sub_kegiatan')
            ->join('sumber_danas', 'sumber_danas.id_sumber_dana', '=', 'sub_kegiatans.id_sumber_dana')
            ->where('sumber_danas.id_sumber_dana', '9cdfced0-87ce-49dc-8268-25ed56420bf7')
        ...
        return view('frontend.Ringkasan_Apbd.pegawai_non_pns.index', compact('rkbus', 'total_anggaran', 'sub_kategori_rkbus', 'status_validasi_rka', 'currentJenisKategori'));
    }
    ...
    public function edit(string $id)
    {
        ...
        return view('frontend.Ringkasan_Apbd.pegawai_non_pns.edit', compact('rkbuBarangJasa', 'user', 'rekening_belanja', 'status_validasi_rka', 'status_validasi', 'komponens', 'sub_kategori_rkbus', 'uraian_satu', 'uraian_dua'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        // Redirect dengan pesan sukses
        return redirect()->route('validasi_non_pns_apbd_admins.index')->with('success', 'Data berhasil diperbarui.');
    }
    ...
    public function destroy(string $id)
    {
        ...
        if (!$rkbu) {
            return redirect()->route('validasi_non_pns_apbd_admins.index')
