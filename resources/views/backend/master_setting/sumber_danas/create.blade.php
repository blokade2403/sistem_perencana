...
<div class="content-wrapper">
    <!-- Content -->
        <form id="confirmSubmitForm" class="needs-validation" method="POST" action="{{route(('sumber_danas.store'))}}">
            @csrf
            <div class="col-xl-12">
                <div class="card-body">
                    <div class="card mb-4">
                        <!-- Current Plan -->
                        <h5 class="card-header"> Create Sumber Dana</h5>
                        <div class="card-body pt-1">
                            <div class="row">
                                        ...
                                        <div class="col-12 col-md-12">
                                            <div class="input-group input-group-merge">
                                                ...
                                                <div class="form-floating form-floating-outline">
                                                    <input type="text" class="form-control" name="nama_sumber_dana" id="basic-addon11" placeholder="John Doe" aria-label="tahun_anggaranname" aria-describedby="basic-addon11" />
                                                    <label for="basic-addon11">Nama Sumber Dana</label>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="mt-2">
                                    ...
                                    <a href="/sumber_danas" class="btn btn-outline-secondary">Back</a>
                                </div>
                            </div>
                        </div>
