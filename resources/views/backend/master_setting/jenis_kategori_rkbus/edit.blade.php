...
<div class="content-wrapper">
    <!-- Content -->
        <form id="confirmSubmitForm" class="needs-validation" method="POST" action="{{ route('jenis_kategori_rkbus.update', $jenisKategoriRkbu->id_jenis_kategori_rkbu) }}">
            @csrf
            @method('PUT')
            <div class="col-xl-12">
                <div class="card-body">
                                    ...
                                    <div id="creditCardForm" class="row g-4">
                                        <div class="col-md-6">
                                            <div class="input-group input-group-merge">
                                                ...
                                                <div class="form-floating form-floating-outline">
                                                    <input type="text" class="form-control" name="kode_jenis_kategori_rkbu" value="{{$jenisKategoriRkbu->kode_jenis_kategori_rkbu}}" id="basic-addon11" placeholder="John Doe" aria-label="tahun_anggaranname" aria-describedby="basic-addon11" />
                                        ...
                                        <div class="col-md-6">
                                            <div class="input-group input-group-merge">
                                                <span class="input-group-text"> <i class="mdi mdi-account me-2"></i></span>
                                                <div class="form-floating form-floating-outline">
                                                    <input type="text" class="form-control" name="nama_jenis_kategori_rkbu" value="{{$jenisKategoriRkbu->nama_jenis_kategori_rkbu}}" id="basic-addon11" placeholder="John Doe" aria-label="tahun_anggaranname" aria-describedby="basic-addon11" />
