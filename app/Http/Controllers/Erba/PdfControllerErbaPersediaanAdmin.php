...
namespace App\Http\Controllers\Erba;
...
class PdfControllerErbaPersediaanAdmin extends Controller
{
    public function downloadPDF(Request $request)
    {
        ...
        $total_anggaran = Rkbu::join('users', 'rkbus.id_user', '=', 'users.id_user')
            ...
            // ->where('pejabats.id_pejabat', $id_pejabat)
            ->where('rkbus.nama_tahun_anggaran', $tahunAnggaran)
            ->where('jenis_kategori_rkbus.id_jenis_kategori_rkbu', '9cdfd364-2946-4ea1-bec2-e1130e8d9f2c')->sum('total_anggaran');
        ...
        $nama_tahun_anggaran = Session::get('tahun_anggaran');
        ...
        $categories = DB::table('jenis_belanjas')
            ...
            ->select(
                ...
                'rkbus.nama_barang',
                'rkbus.stok',
                'rkbus.rata_rata_pemakaian',
                'rkbus.pengadaan_sebelumnya',
                'rkbus.proyeksi_sisa_stok',
                'rkbus.kebutuhan_tahun_x1',
                'rkbus.kebutuhan_plus_buffer',
                'rkbus.buffer',
                'rkbus.rencana_pengadaan_tahun_x1',
                'rkbus.ppn',
                'users.nama_lengkap',
                'units.nama_unit',
                'rkbus.spek',
                ...
                <table border="0">
                    <tr>
                        <td width="60%" align="left">
                            <h3 style="font-size:8px; font-weight: bold;">B. RINCIAN ANGGARAN PENDAPATAN, BELANJA DAN PEMBIAYAAN</h3>
                        </td>
                    </tr>
                    <tr>
                        <td width="100%" align="center">
                            ...
                            <h3 style="font-size:8px; font-weight: normal;">BELANJA BISNIS DAN ANGGARAN</h3>
                            <h3 style="font-weight: normal; font-size:8px; line-height:0;">ANGGARAN  BELANJA OPERASI TAHUN ANGGARAN ' . $tahunAnggaran . '</h3>
                        </td>
                    </tr>
                </table>';
        ...
        $htmlBody = view('erba.print_erba_persediaan', compact('rkbus', 'tanggal_perencanaans', 'nama_tahun_anggaran', 'angka_tahun',  'jabatan_kabag', 'nama_rumah_sakit', 'nama_pejabat', 'nip_pejabat_kabag', 'nip_direktur', 'nama_direktur', 'pdf', 'sub_kategori_rkbus', 'status_validasi_rka', 'total_anggaran', 'categories', 'namaProgram', 'namaKegiatan', 'namaSubKegiatan', 'kodeProgram', 'kodeKegiatan', 'kodeSubKegiatan'))->render();
