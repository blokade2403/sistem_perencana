            ...
            <div class="card invoice-preview-card">
                ...
                <div class="col-12">
                    <div class="card-body">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <form action="{{ route('usulan_barang_barjass.delete_detail', $item->id_usulan_barang_detail) }}" method="POST" class="delete-form">
                                                @csrf
                                                @method('DELETE')
                        ...
                        <form action="{{ route('usulan_barangs.updateStatus', $invoice->id_usulan_barang) }}" method="POST" id="confirmSubmitForm" enctype="multipart/form-data" validate>
                            @csrf
                        <div class="mt-2">
                            
                            <button type="submit" class="btn btn-primary me-2">Kirim Usulan</button>
                            <a href="{{route('usulan_barang_barjass.index')}}" class="btn btn-outline-secondary">Kembali</a>
                        </form>
                        </div>
                    </div>
                </div>
