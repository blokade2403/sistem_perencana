...
<div class="content-wrapper">
    <!-- Content -->
        ...
        @endif
        <form id="confirmSubmitForm" class="needs-validation" method="POST" action="{{ route(('rekening_belanjas.store')) }}">
            @csrf
            <div class="col-xl-12">
                <div class="card-body">
                    <div class="card mb-4">
                                    ...
                                    <div id="creditCardForm" class="row g-4">
                                        <div class="col-12 col-md-6">
                                            <div class="input-group input-group-merge">
                                                ...
                                                <div class="form-floating form-floating-outline">
                                                    <input type="text" class="form-control" name="kode_rekening_belanja" id="basic-addon11" placeholder="Isi Nama rekening_belanjas" aria-label="pejabatname" aria-describedby="basic-addon11" />
                                        ...
                                        <div class="col-12 col-md-6">
                                            <div class="input-group input-group-merge">
                                                <span class="input-group-text"> <i class="mdi mdi-account me-2"></i></span>
                                                <div class="form-floating form-floating-outline">
                                                    <input type="text" class="form-control" name="nama_rekening_belanja" id="basic-addon11" placeholder="Isi Nama rekening_belanjas" aria-label="pejabatname" aria-describedby="basic-addon11" />
                                                ...
                                                <div class="form-floating form-floating-outline">
                                                    <select name="id_aktivitas" class="select2 form-select form-select-lg" data-allow-clear="true">
                                                        ...
                                                        @foreach ($aktivitas as $pejabat)
                                                            <option value="{{$pejabat->id_aktivitas}}">{{$pejabat->kode_aktivitas}}. {{$pejabat->nama_aktivitas}}</option>   
                                                        @endforeach
                                                    </select>
