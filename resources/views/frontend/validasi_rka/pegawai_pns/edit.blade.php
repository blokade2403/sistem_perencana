...
<div class="content-wrapper">
    <!-- Content -->
        ...
        @endif
        <form class="needs-validation" action="{{route('validasi_pegawai_pns_rkas.update', $pegawai->id_rkbu)}}"  method="POST" id="confirmSubmitForm" enctype="multipart/form-data" validate>
            @csrf
            @method('PUT')
            <div class="col-xl-12">
                <div class="card-body">
                                        ...
                                        <div class="col-6 col-md-12 mb-4">
                                            <div class="form-floating form-floating-outline">
                                                ...
                                                <div class="form-floating mt-3">
                                                    <input type="text" id="id_sub_kategori_rekening" name="id_sub_kategori_rekening" value="{{$pegawai->id_sub_kategori_rekening}}" class="form-control" placeholder="Jenis Belanja">
                                    ...
                                    <div class="col-12 col-md-6">
                                        <div class="form-floating form-floating-outline">
                                            <select name="id_status_validasi_rka" class="select2 form-select form-select-lg" data-allow-clear="true">
                                                <option value="{{ $pegawai->id_status_validasi_rka }}">
                                                    {{ $pegawai->status_validasi_rka->nama_validasi_rka }}
                                                </option>
                    ...
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            ...
                            <div class="mt-2">
                                ...
                                <a href="{{route('validasi_pegawai_pns_rkas.index')}}" class="btn btn-outline-secondary">Kembali</a>
                            </div>
                        </div>
                    </div>
                </div>
