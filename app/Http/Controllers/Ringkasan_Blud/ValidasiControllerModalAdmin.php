...
use App\DataTables\ValidasiControllerModalAdminDataTable;

class ValidasiControllerModalAdmin extends Controller
{
    ...
    //     return view('frontend.Ringkasan_Blud.modal.index', compact(
    //         'rkbus',
    //         'total_anggaran',
    //         'sub_kategori_rkbus',
    //         'status_validasi_rka',
    ...
    public function index(ValidasiControllerModalAdminDataTable $dataTable, Request $request)
    {
        $id_pejabat          = session('id_pejabat');
        $id_user             = session('id_user');
        ...
        return $dataTable->render('frontend.Ringkasan_Blud.modal.index', [
    ...
    public function edit(string $id)
    {
        ...
        return view('frontend.Ringkasan_Blud.modal.edit', compact('rkbuBarangJasa', 'user', 'rekening_belanja', 'status_validasi_rka', 'status_validasi', 'komponens', 'sub_kategori_rkbus', 'uraian_satu', 'uraian_dua'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        // Redirect dengan pesan sukses
        return redirect()->route('validasi_modal_admins.index')->with('success', 'Data berhasil diperbarui.');
    }
    ...
    public function destroy(string $id)
    {
        ...
        if (!$rkbu) {
            return redirect()->route('validasi_modal_admins.index')
