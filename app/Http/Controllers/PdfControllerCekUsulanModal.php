...
class PdfControllerCekUsulanModal extends Controller
{
    /**
     * Display a listing of the resource.
     */
    public function downloadPDFCekModal(Request $request, $id_usulan_barang)
    {
        ...
        checkPageBreak($pdf, 85); // Memastikan ruang yang cukup untuk tanda tangan
        $htmlSignatureTable = '
            <table rules="none">
                <tr bgcolor="#ffffff">
