    ...
    <!-- Content -->
                                        ...
                                        <div class="user-profile-info">
                                            ...
                                            <div class="btn-toolbar demo-inline-spacing" role="toolbar" aria-label="Toolbar with button groups">
                                                <div class="btn-group" role="group" aria-label="First group">
                                                    <a href="{{route('kegiatans.create')}}" class="btn btn-outline-secondary btn-primary">
        ...
        @else
                                <tr>
                                    ...
                                    <td>{{ $no++}}</td>
                                    <td>{{ $key->program->kode_program }}</td>
                                        ...
                                        <td>
                                            <div class="btn-group" id="dropdown-icon-demo">
                                                ...
                                                <ul class="dropdown-menu">
                                                    <li>
                                                        <a href="{{ route('kegiatans.edit', $key->id_kegiatan) }}" class="dropdown-item d-flex align-items-center"><i class="mdi mdi-chevron-right scaleX-n1-rtl"></i>Edit</a>
                                                    </li>
                                                    <form action="{{ route('kegiatans.destroy', $key->id_kegiatan) }}" method="POST">
                                                        @csrf
                                                        @method('DELETE')
