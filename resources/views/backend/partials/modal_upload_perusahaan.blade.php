        ...
        <div class="modal-content p-3 p-md-5">
            <div class="modal-body pt-3 pt-md-0 px-0 pb-md-0">
                ...
                <form action="{{ route('perusahaan.import') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="col-lg-9">
                        <label class="form-label fw-normal" for="modalRnFLink"><a href="{{route('perusahaan.downloadReport')}}" class="btn btn-outline-secondary btn-primary"> Download Format. 🥳 </a></label>
                    </div>
