            ...
            <div class="card invoice-preview-card">
                ...
                <div class="col-12">
                    <div class="card-body">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <a href="{{ route('rekap_usulans.edit_keranjang', $item->id_usulan_barang_detail) }}" class="btn btn-icon btn-outline-primary waves-effect">
                        ...
                        <form action="{{route('rekap_usulans.updateValidasi', $no_inv->no_usulan_barang)}}" method="POST" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                            ...
                            <div class="card-body">
                                        ...
                                        <div class="col-6 col-md-12 mb-3">
                                         <div class="input-group input-group-merge">
                                             ...
                                             <div class="form-floating form-floating-outline">
                                                 <input type="datetime-local" name="created_at" value="{{ \Carbon\Carbon::parse($no_inv->created_at)->format('Y-m-d\TH:i') }}" class="form-control" aria-label="Amount (to the nearest dollar)" />
                                                 <label>Tanggal Usulan Barang</label>
                                             </div>
                                         </div>
                                     </div>
                                    </div>
                                ...
                                <div class="mt-2">
                                    ...
                                    @else
                                        ...
                                        <a href="{{route('rekap_usulans.index')}}" class="btn btn-outline-secondary">Kembali</a>
                                    @endif
                                    <a href="{{ route('cek_usulan_barang_barjass.downloadPDF', ['id_usulan_barang' => $invoice->id_usulan_barang]) }}" class="btn btn-info waves-primary waves-effect">
