...
<div class="content-wrapper">
    <!-- Content -->
        <form id="confirmSubmitForm" class="needs-validation" method="POST" action="{{ route('tahun_anggarans.update', $TahunAnggaran->id) }}">
            @csrf
            @method('PUT')
            <div class="col-xl-12">
                <div class="card-body">
                        ...
                        <div class="card-body pt-1">
                            <div class="row">
                                        ...
                                        <div class="col-12 col-md-4">
                                            <div class="input-group input-group-merge">
                                                ...
                                                <div class="form-floating form-floating-outline">
                                                    <input type="text" class="form-control" name="nama_tahun_anggaran" value="{{$TahunAnggaran->nama_tahun_anggaran}}" id="basic-addon11" placeholder="John Doe" aria-label="tahun_anggaranname" aria-describedby="basic-addon11" />
                                            ...
                                            <div class="input-group input-group-merge">
                                                <div class="form-floating form-floating-outline">
                                                    <select name="status" class="select2 form-select form-select-lg" data-allow-clear="true">
                                                        <option value="{{$TahunAnggaran->status}}">{{$TahunAnggaran->status}}</option>
                                ...
                                <div class="mt-2">
                                    ...
                                    <a href="{{route('tahun_anggarans.index')}}" class="btn btn-outline-secondary">Back</a>
                                </div>
                            </div>
                        </div>
