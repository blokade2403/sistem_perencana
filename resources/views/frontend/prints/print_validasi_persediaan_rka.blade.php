...
<div class="container">
    ...
    <table class="table-data">
        <thead>
            <tr class="text-center">
                <th rowspan="2" width="4%" align="center">No</th>
                    <th rowspan="2" width="20%" align="center">Nama / Jenis Barang</th>
                    ...
                    <th rowspan="2" width="6%" align="center">Pajak</th>
                    <th rowspan="2" width="10%" align="center">Jumlah</th>
            </tr>
            <tr>
            ...
            <tr class="text-center">
                ...
                <th width="10%" align="center">14=(11x12)+(13)</th>
            </tr>
        </thead>
        <tbody>
            @php
                        ...
                        @foreach ($subKategoriRkbus as $subKategori)
                            ...
                            @foreach ($categories->where('kode_sub_kategori_rkbu', $subKategori->kode_sub_kategori_rkbu) as $rkbu)
                                <tr>
                                        ...
                                        <td width="6%" align="center">{{$rkbu->ppn }}</td>
        ...
        <table cellspacing="1" cellpadding="1">
            <tr bgcolor="#ffffff">
              <th colspan="10" rowspan="2" width="70%" style="text-align:center;line-height:7px;"><h1></h1></th>
              <th colspan="2" width="18%" align="center"><h4>Total</h4></th>
