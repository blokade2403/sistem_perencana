        ...
        <div class="modal-content p-3 p-md-5">
            <div class="modal-body pt-3 pt-md-0 px-0 pb-md-0">
                ...
                <div class="text-center mb-4">
                    ...
                    <h3 class="mb-2">Upload Data RKBU Persediaan</h3>
                ...
                <form action="" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="col-lg-9">
                        <label class="form-label fw-normal" for="modalRnFLink"><a href="{{route('rkbu_persediaans.downloadReport')}}" class="btn btn-outline-secondary btn-primary"> Download Format. 🥳 </a></label>
                    </div>
