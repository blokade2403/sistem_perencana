...
class ValidasiUsulanBarangPersediaanRkaController extends Controller
{
    /**
    ...
    public function index($id_sub_kategori_rkbu = null)
    {
        ...
        return view('frontend.validasi_usulan_rka.validasi_usulan_barang_persediaan.index', compact('usulan_barangs', 'get_barangs', 'id_usulan', 'sub_kategori_rkbus'));
    }
    ...
    public function updateValidasi(Request $request, $no_usulan_barang)
    {
        ...
        return redirect()->route('validasi_usulan_persediaan_rkas.index')
    ...
    public function keranjang($id_usulan_barang)
    {
        ...
        return view('frontend.validasi_usulan_rka.validasi_usulan_barang_persediaan.keranjang', $data);
    }
    ...
    public function show($id_usulan_barang)
    {
        ...
        return view('frontend.validasi_usulan_rka.validasi_usulan_barang_persediaan.invoice', $data, compact('sub_kategori_rkbus', 'usulan_barangs', 'id_usulan', 'invoice'));
    }
