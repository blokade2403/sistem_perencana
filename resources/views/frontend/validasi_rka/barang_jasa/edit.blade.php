...
<div class="content-wrapper">
    <!-- Content -->
        ...
        @endif
        <form class="needs-validation" action="{{ route('validasi_barang_jasa_rkas.update', $rkbuBarangJasa->id_rkbu) }}"  method="POST" id="confirmSubmitForm" enctype="multipart/form-data" validate>
            @csrf
            @method('PUT')
            <div class="col-xl-12">
                <div class="card-body">
                    ...
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            <div id="formAccountSettings">
                                ...
                                {{-- @include('frontend.validasi_rka.partials.modal_upload_fase_penetapan_pergeseran'); --}}
                                    <div class="mt-2">
                                        ...
                                        <a href="{{route('validasi_barang_jasa_rkas.index')}}" class="btn btn-outline-secondary">Kembali</a>
                                        @else
