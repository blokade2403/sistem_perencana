                                                ...
                                                <div class="user-profile-info">
                                                    ...
                                                    <ul class="list-inline mb-0 d-flex align-items-center flex-wrap justify-content-sm-start justify-content-center gap-2">
                                                        ...
                                                        <div class="demo-inline-spacing">
                                                            ...
                                                            <a href="{{route('rkbu_pegawai_pnss.create')}}" class="btn rounded-pill btn-label-info waves-effect">
                                                            ...
                                                            <a href="{{route('rkbu_pegawai_pnss.downloadPDF')}}" class="btn rounded-pill btn-label-warning waves-effect">
                        ...
                        <div class="col-12">
                            <div class="card">
                                <form method="POST" action="" id="form-delete">
                                    <div class="card-body">
                                         <!-- Filter Form -->
                             <form action="{{ route('rkbu_pegawai_pnss.index') }}" method="GET">
                                                ...
                                                <tbody>
                                                    ...
                                                    @else
                                                        ...
                                                        @foreach ($rkbus as $rkbus)
                                                            ...
                                                            <td class="py-2"><span class="fa-xs">{{$rkbus->sub_kategori_rkbu->kode_sub_kategori_rkbu}}. {{$rkbus->sub_kategori_rkbu->nama_sub_kategori_rkbu}}</span></td>
                                                                     ...
                                                                     <div class="demo-inline-spacing">
                                                                        ...
                                                                        <div class="btn-group" id="dropdown-icon-demo">
                                                                            ...
                                                                            <ul class="dropdown-menu">
                                                                                <li>
                                                                                    <a href="{{ route('rkbu_pegawai_pnss.edit', $rkbus->id_rkbu) }}" class="dropdown-item d-flex align-items-center"><i class="mdi mdi-chevron-right scaleX-n1-rtl"></i>Edit</a>
                                                                                </li>
                                                                                <form action="{{route('rkbu_pegawai_pnss.destroy', $rkbus->id_rkbu)}}" method="POST" class="delete-form">
                                                                                    @csrf
                                                                                    @method('DELETE')
