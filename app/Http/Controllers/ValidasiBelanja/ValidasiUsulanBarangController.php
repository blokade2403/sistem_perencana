...
class ValidasiUsulanBarangController extends Controller
{
    ...
    public function index(Request $request, $id_sub_kategori_rkbu = null)
    {
        ...
        return view('frontend.validasi_usulan_admin.validasi_usulan_barang.index', compact('usulan_barangs', 'sub_kategori_usulan_belanja', 'get_barangs', 'id_usulan', 'sub_kategori_rkbus'));
    }
    ...
    public function updateValidasi(Request $request, $no_usulan_barang)
    {
        ...
        return redirect()->route('validasi_usulan_barangs.index')
    ...
    public function keranjang($id_usulan_barang)
    {
        ...
        return view('frontend.validasi_usulan_admin.validasi_usulan_barang.keranjang', $data);
    }
    ...
    public function destroy(UsulanBarang $usulanBarang)
    {
        ...
        return redirect()->route('validasi_usulan_barangs.index')->with('success', 'RKBU Barang Jasa dan detailnya berhasil dihapus.');
    }
    ...
    public function doDelete($id_usulan_barang)
    {
        ...
        return redirect()->route('validasi_usulan_barangs.index')->with('success', 'Data usulan barang berhasil dihapus.');
    }
}
