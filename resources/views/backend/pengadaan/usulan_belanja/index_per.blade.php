...
@section('container')
@include('backend.partials.modal_upload_usulan_barang_detail')
    <div class="card-body">
        <!-- Header -->
            <div class="row">
                <div class="col-12">
                            ...
                            <table id="example" class="table table-striped" style="width:100%">
                                ...
                                <tbody>
                                    @php
                                            ...
                                            <td>
                                                <div class="demo-inline-spacing">
                                                    <a href="{{route('usulan_belanja_per_admin_ppks.show', $key->id_usulan_barang)}}" class="btn btn-icon btn-primary waves-effect waves-light">
