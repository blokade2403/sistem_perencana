...
<div class="content-wrapper">
    <!-- Content -->
        <form id="confirmSubmitForm" class="needs-validation" method="POST" action="{{route('pptks.update', $pptk->id_pptk)}}">
            @csrf
            @method('PUT')
            <div class="col-xl-12">
                <div class="card-body">
                    <div class="card mb-4">
                        <!-- Current Plan -->
                        <h5 class="card-header"> Create PPTK</h5>
                        <div class="card-body pt-1">
                            <div class="row">
                                    ...
                                    <div id="creditCardForm" class="row g-4">
                                        <div class="col-12 col-md-4">
                                            <div class="input-group input-group-merge">
                                                ...
                                                <div class="form-floating form-floating-outline">
                                                    <input type="text" class="form-control" name="nama_pptk" value="{{$pptk->nama_pptk}}" id="basic-addon11" placeholder="John Doe" aria-label="tahun_anggaranname" aria-describedby="basic-addon11" />
                                        ...
                                        <div class="col-12 col-md-8">
                                            <div class="input-group input-group-merge">
                                                <span class="input-group-text"> <i class="mdi mdi-account me-2"></i></span>
                                                <div class="form-floating form-floating-outline">
                                                    <input type="text" class="form-control" name="nip_pptk" value="{{$pptk->nip_pptk}}" id="basic-addon11" placeholder="John Doe" aria-label="tahun_anggaranname" aria-describedby="basic-addon11" />
                                        ...
                                        <div class="col-12 col-md-8">
                                            <div class="input-group input-group-merge">
                                                <div class="form-floating form-floating-outline">
                                                    ...
                                                    <option value="{{$pptk->id_tahun_anggaran}}">{{$pptk->nama_tahun_anggaran}}</option>
                                        ...
                                        <div class="col-12 col-md-8">
                                            <div class="input-group input-group-merge">
                                                <div class="form-floating form-floating-outline">
                                                    ...
                                                    <option value={{$pptk->status_pptk}}>{{$pptk->status_pptk}}</option>
                                ...
                                <div class="mt-2">
                                    ...
                                    <a href="/pptks" class="btn btn-outline-secondary">Back</a>
                                </div>
                            </div>
                        </div>
