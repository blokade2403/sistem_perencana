...
<div class="content-wrapper">
    <!-- Content -->
        <form class="needs-validation" method="POST" action="{{ route('level_users.update', $level_user->id_level) }}">
            @csrf
            @method('PUT')
            <div class="col-xl-12">
                <div class="card-body">
                    <div class="card mb-4">
                        <!-- Current Plan -->
                        <h5 class="card-header"> Edit Level User</h5>
                        <div class="card-body pt-1">
                            <div class="row">
                                        ...
                                        <div class="col-12 col-md-12">
                                            <div class="input-group input-group-merge">
                                                ...
                                                <div class="form-floating form-floating-outline">
                                                    <input type="text" class="form-control" name="nama_level_user" value="{{$level_user->nama_level_user}}" id="basic-addon11" placeholder="John Doe" aria-label="tahun_anggaranname" aria-describedby="basic-addon11" />
                                                    <label for="basic-addon11">Nama Level</label>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="mt-2">
                                    ...
                                    <a href="/level_users" class="btn btn-outline-secondary">Back</a>
                                </div>
                            </div>
                        </div>
