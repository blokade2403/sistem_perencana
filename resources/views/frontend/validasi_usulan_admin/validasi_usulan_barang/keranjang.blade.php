            ...
            <div class="card invoice-preview-card">
                ...
                <div class="col-12">
                    <div class="card-body">
                            ...
                            <table id="example" class="table table-striped">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="fy-2 text-nowrap"><small>Rp. {{ number_format($item->harga_barang) }}</small></td>
                                        <td class="fy-2 text-nowrap"><small>{{ $item->jumlah_usulan_barang }} {{ $item->satuan_1_detail }}/{{ $item->satuan_2_detail }}</small></td>
                                        <td><small>Rp. {{ number_format($item->harga_barang * $item->ppn / 100, 0, ',', '.') }}</small></td>
                                        <td class="fy-2 text-nowrap"><small>Rp. {{ number_format($item->total_anggaran_usulan_barang, 0, ',', '.') }}</small></td>
                        ...
                        <form action="{{route('validasi_usulan_barangs.updateValidasi', $no_inv->no_usulan_barang)}}" method="POST" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-md-5 mb-md-0 mb-3">
                                        <div class="form-floating form-floating-outline">
                                            <select name="status_validasi_perencana" id="status_validasi_perencana" class="select2 form-select form-select-lg" data-allow-clear="true">
                                                <option value="{{$no_inv->status_permintaan_barang}}">{{$no_inv->status_permintaan_barang}}</option>
                                                <option value="Disetujui Perencana">Disetujui Perencana</option>
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        <div class="mb-3">
                                            ...
                                            <textarea class="form-control" rows="2" id="note" name="keterangan_perencana" placeholder="Invoice note">{{$no_inv->keterangan_perencana}}</textarea>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-12">
                                ...
                                <div class="mt-2">
                                    ...
                                    @else
                                        ...
                                        <a href="{{route('validasi_usulan_barangs.index')}}" class="btn btn-outline-secondary">Kembali</a>
                                    @endif
                                </div>
                            </div>
                        </form>
