        ...
        @else
                                <tr>
                                    @php
                                        $no = 1;
                                    @endphp
                                    @foreach ($penempatans as $key)
                                    <td>{{ $no++}}</td>
                                    <td>{{ $key->lokasi_barang }}</td>
                                    <td>{{ $key->tempat_lokasi }}</td>
                                    <td>{{ $key->gedung }}</td>
                                        ...
                                        <td>
                                            <div class="btn-group" id="dropdown-icon-demo">
                                                ...
                                                <ul class="dropdown-menu">
                                                    <li>
                                                        <a href="{{ route('penempatans.edit', $key->id_penempatan) }}" class="dropdown-item d-flex align-items-center"><i class="mdi mdi-chevron-right scaleX-n1-rtl"></i>Edit</a>
                                                    </li>
                                                    <form action="{{ route('penempatans.destroy', $key->id_penempatan) }}" method="POST">
                                                        @csrf
                                                        @method('DELETE')
