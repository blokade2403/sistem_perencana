    ...
    <table class="table-data">
        ...
        <tbody>
            ...
            @foreach ($categories as $jenisBelanja)
                                    <tr class="jenis">
                                        <td colspan="2" width="85%" class="fs-14">
                                ...
                                @foreach ($jenisBelanja->jenis_kategori_rkbus as $JenisKategori)
                                        <tr class="kategori mb-1 mt-1">
                                            ...
                                            <th colspan="2" width="76%">{{ $JenisKategori->kode_jenis_kategori_rkbu }}. {{ $JenisKategori->nama_jenis_kategori_rkbu }}</th>
                                            <td style="text-align: right;" width="15%">
                                    ...
                                    @foreach ($JenisKategori->obyek_belanjas as $ObyekBelanja)
                                        @foreach ($ObyekBelanja->kategori_rkbus as $KategoriRkbu)
                                            <tr class="mb-1 mt-1">
                                                ...
                                                <th colspan="2" width="72%">{{ $KategoriRkbu->kode_kategori_rkbu }}. {{ $KategoriRkbu->nama_kategori_rkbu }}</th>
                                                <td style="text-align: right;" width="15%">
                                        ...
                                        @foreach ($KategoriRkbu->sub_kategori_rkbus as $SubKategoriRkbu)
                                            <tr>
                                                ...
                                                <td width="4%"></td>
                                                <td width="4%"></td>
                                                <th class="text-left fa-14" width="72%">{{ $SubKategoriRkbu->kode_sub_kategori_rkbu }}. {{ $SubKategoriRkbu->nama_sub_kategori_rkbu }}</th>
                                                <td style="text-align: right;" width="15%">
