               ...
               <div class="card-body">
                   ...
                   <div class="card-body">
                       <div class="d-flex justify-content-between flex-wrap">
                           <div class="m-3">
                               <h6 class="pb-2">ID USULAN: <span class="badge bg-info"></span></h6>
                                {{-- @dd($no_inv) --}}
                               <table>
                                   <tbody>
                                       <tr>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <div class="d-flex justify-content-center align-item-center gap-2">
                                            <a href="{{ route('usulan_spj_barjass.edit', $item->id_usulan_barang_detail) }}" class="btn btn-icon btn-outline-primary waves-effect">
                                                <span class="tf-icons mdi mdi-checkbox-marked-circle-outline"></span>
                                            </a>
                                            <form action="{{ route('usulan_spj_barjass.delete', $item->id_spj_detail) }}" method="POST" class="delete-form">
                                                @csrf
                                                @method('DELETE')
                   ...
                   <form action="{{ route('usulan_spj_barjass.updateStatus', $no_inv->id_spj) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="card-body">
                        ...
                        <div class="mt-2">
                                ...
                                <a href="{{route('usulan_spj_barjass.index')}}" class="btn btn-label-secondary">
                                    Kembali
                                </a>
