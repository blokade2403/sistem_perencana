...
@section('container')
                    ...
                    <div class="card">
                        ...
                        <table id="example" class="table table-bordered" style="min-width: 845px">
                            <thead>
                                <tr>
                                    <th>No</th>
                                    <th>Nama KSP/Ka. ins</th>
                                    <th>NIP</th>
                                    <th>Jabatan KSP/Ka. ins</th>
                                    <th>Nama Pejabat</th>
                                    <th>Status</th>
                                    <th>Action</th>
                                </tr>
        ...
        @else
                                <tr>
                                    ...
                                    <td>{{ $ksp->nama_ksp }}</td>
                                    <td>{{ $ksp->nip_ksp }}</td>
                                    <td>{{ $ksp->fungsional->jabatan_fungsional }}</td>
                                    <td>{{ $ksp->pejabat->nama_pejabat }}</td>
                                    <td>
                                        @if ($ksp->status == 'aktif')
                                        ...
                                        <td>
                                            <div class="btn-group" id="dropdown-icon-demo">
                                                ...
                                                <ul class="dropdown-menu">
                                                    <li>
                                                        <a href="{{ route('ksps.edit', $ksp->id_ksp) }}" class="dropdown-item d-flex align-items-center"><i class="mdi mdi-chevron-right scaleX-n1-rtl"></i>Edit</a>
                                                    </li>
                                                    <form action="{{ route('ksps.destroy', $ksp->id_ksp) }}" method="POST" class="delete-form">
                                                        @csrf
                                                        @method('DELETE')
