...
class UsulanBarangPersediaanadminPpkController extends Controller
{
    ...
    public function index($id_sub_kategori_rkbu = null)
    {
        ...
        return view('backend.pengadaan.usulan_belanja.index_per', compact('usulan_barangs', 'get_barangs', 'id_usulan', 'sub_kategori_rkbus'));
    }
    ...
    public function show($id_usulan_barang)
    {
        ...
        return view('backend.pengadaan.usulan_belanja.invoice_per', $data, compact('sub_kategori_rkbus', 'usulan_barangs', 'id_usulan', 'invoice'));
    }
    ...
    public function edit($id)
    {
        ...
        // Kirim data ke view
        return view('backend.pengadaan.usulan_belanja.edit_per', compact('usulan_barang_details', 'rkbu', 'uraian1', 'uraian2'));
    }
