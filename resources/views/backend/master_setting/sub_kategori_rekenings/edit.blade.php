...
<div class="content-wrapper">
    <!-- Content -->
        ...
        @endif
        <form id="confirmSubmitForm" class="needs-validation" method="POST" action="{{ route('sub_kategori_rekenings.update', $sub_kategori_rekenings->id_sub_kategori_rekening) }}">
            @csrf
            @method('PUT')
            <div class="col-xl-12">
                <div class="card-body">
                                    ...
                                    <div id="creditCardForm" class="row g-4">
                                        <div class="col-12 col-md-6">
                                            <div class="input-group input-group-merge">
                                                ...
                                                <div class="form-floating form-floating-outline">
                                                    <input type="text" class="form-control" name="kode_sub_kategori_rekening" value="{{$sub_kategori_rekenings->kode_sub_kategori_rekening}}" id="basic-addon11" placeholder="Isi Nama KSP" aria-label="pejabatname" aria-describedby="basic-addon11" />
                                        ...
                                        <div class="col-12 col-md-6">
                                            <div class="input-group input-group-merge">
                                                <span class="input-group-text"> <i class="mdi mdi-account me-2"></i></span>
                                                <div class="form-floating form-floating-outline">
                                                    <input type="text" class="form-control" name="nama_sub_kategori_rekening" value="{{$sub_kategori_rekenings->nama_sub_kategori_rekening}}" id="basic-addon11" placeholder="Isi" aria-label="pejabatname" aria-describedby="basic-addon11" />
                                            ...
                                            <div class="input-group input-group-merge">
                                                <div class="form-floating form-floating-outline">
                                                    <select class="select2 form-select form-select-lg" data-allow-clear="true" name="id_kategori_rekening" >
                                                        <option value="{{$sub_kategori_rekenings->id_kategori_rekening}}">{{$sub_kategori_rekenings->kategori_rekening->kode_kategori_rekening}}. {{$sub_kategori_rekenings->kategori_rekening->nama_kategori_rekening}}</option>
