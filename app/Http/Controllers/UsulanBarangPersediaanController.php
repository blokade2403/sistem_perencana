...
class UsulanBarangPersediaanController extends Controller
{
    ...
    public function index($id_sub_kategori_rkbu = null)
    {
        ...
        return view('frontend.usulan_barang_persediaan.index', compact('usulan_barangs', 'get_barangs', 'id_usulan', 'sub_kategori_rkbus'));
    }
    ...
    public function keranjang($id_usulan_barang)
    {
        ...
        return view('frontend.usulan_barang_persediaan.keranjang', $data);
    }
            ...
            if (!empty($getdatadetail->id_usulan_barang_detail)) {
                ...
                if ($produk->jumlah_vol > $getdatadetail->jumlah_usulan_barang) {
                    ...
                    $data1 = [
                        ...
                        'total_ppn'                     => $total_anggaran_belanja * 0.1, // Contoh PPN 10%
    ...
    {
        $invoice = DB::table('usulan_barangs')->where('id_usulan_barang', $id_usulan_barang)->first();
        if (!$invoice) {
            dd("Invoice tidak ditemukan untuk ID:", $id_usulan_barang);
        }
        return $invoice;
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('usulan_barang_persediaans.index')->with('success', 'Data usulan barang berhasil ditambahkan!');
    }
    ...
    public function show(UsulanBarang $usulanBarang, $id_usulan_barang)
    {
        ...
        return view('frontend.usulan_barang_persediaan.invoice', $data, compact('sub_kategori_rkbus', 'usulan_barangs', 'id_usulan'));
    }
    ...
    public function updateStatus(Request $request, $id)
    {
        ...
        return redirect()->route('usulan_barang_persediaans.show', $usulanBarang->id_usulan_barang)
    ...
    public function edit($id)
    {
        ...
        // Kirim data ke view
        return view('frontend.usulan_barang_persediaan.edit', compact('usulan_barang_details',  'rkbu', 'uraian1', 'uraian2'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        $validator = Validator::make(
            ...
            [
                'sisa_stok'                         => 'Sisa Stok wajib diisi.',
                'pengkali'                          => 'Pengkali  wajib diisi.',
                'buffer_stok'                       => 'Buffer Stok wajib diisi.',
                'rata2_pemakaian'                   => 'Rata-rata Pemakaian wajib diisi.',
                'stok_minimal'                      => 'Stok Minimal wajib diisi.',
        ...
        if ($totalAnggaranSetelahUpdate <= $rkbu->total_anggaran) {
            ...
            return redirect()->route('usulan_barang_persediaans.index', $usulanBarangDetail->id_usulan_barang)
                ->with('success', 'Detail usulan barang berhasil diperbarui.');
        } else {
            // Jika total anggaran setelah update melebihi, tampilkan alert
            return redirect()->back()->with('error', 'Total Usulan melebihi Pagu Anggaran.');
        }
    }
    ...
    public function destroy(UsulanBarang $usulanBarang)
    {
        ...
        return redirect()->route('usulan_barang_persediaans.index')->with('success', 'RKBU Barang Jasa dan detailnya berhasil dihapus.');
    }
    ...
    public function doDeleteDetailKeranjang($id_usulan_barang_detail)
    {
        ...
        return redirect()->route('usulan_barang_persediaans.index', $id_usulan_barang)->with('success', 'Detail usulan barang berhasil dihapus.');
    }
    ...
    public function doDelete($id_usulan_barang)
    {
        ...
        return redirect()->route('usulan_barang_persediaans.index')->with('success', 'Data usulan barang berhasil dihapus.');
    }
}
