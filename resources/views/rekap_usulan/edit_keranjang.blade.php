...
<form class="needs-validation" method="POST" action="{{ route('rekap_usulans.update', $usulan_barang_details->id_usulan_barang_detail) }}" id="confirmSubmitForm" enctype="multipart/form-data" validate>
    @csrf
    @method('PUT')
                                ...
                                <div class="col-md-12">
                                    <div class="row">
                                        ...
                                        <div class="col-md-3 mb-4">
                                            <div class="alert alert-warning mb-4 alert-dismissible" role="alert">
                                                <span class="ms-4 ps-1">Sisa Volume </span><span class="text-end">:</span> <span class="text-danger fa-ms"></span><br />
                                                <span class="ms-4 ps-1">Sisa Anggaran </span><span class="text-end">:</span> <span class="text-danger fa-ms">Rp. </span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                                    ...
                                    <div id="creditCardForm" class="row g-4">
                                        ...
                                        <div class="col-12 col-md-6">
                                            <div class="input-group">
                                                <div class="form-floating form-floating-outline">
                                                    <input type="number" class="form-control" id="rata2_pemakaian" name="rata2_pemakaian" value="{{ $usulan_barang_details->rata2_pemakaian }}" onkeyup="sum_persediaan();" placeholder="1" aria-label="Amount (to the nearest dollar)" />
                                        ...
                                        <div class="col-12 col-md-3">
                                            <div class="input-group">
                                                <div class="form-floating form-floating-outline">
                                                    <input type="number" class="form-control" id="sisa_stok" name="sisa_stok" value="{{ $usulan_barang_details->sisa_stok }}" onkeyup="sum_persediaan();" placeholder="1" aria-label="Amount (to the nearest dollar)" />
                                        ...
                                        <div class="col-12 col-md-3">
                                            <div class="input-group">
                                                <div class="form-floating form-floating-outline">
                                                    <input type="number" class="form-control" id="buffer_stok" name="buffer_stok" value="{{ $usulan_barang_details->buffer_stok }}" onkeyup="sum_persediaan();" placeholder="1" aria-label="Amount (to the nearest dollar)" />
                                ...
                                <div class="col-md-6 ">
                                    ...
                                    <div id="creditCardForm" class="row g-4">
                                        ...
                                        <div class="col-12 col-md-4">
                                            <div class="input-group">
                                                <div class="form-floating form-floating-outline">
                                                    <input type="number" name="pengkali" class="form-control" id="pengkali"  onkeyup="sum_farmasi();" value="{{ old('pengkali', $usulan_barang_details->pengkali ?? 1) }}"
                                                    onkeyup="sum_farmasi();"placeholder="1" aria-label="Amount (to the nearest dollar)" required />
                                                    <label for="basic-addon11">Vol Pengkali</label>
                                        ...
                                        <div class="col-6 col-md-4">
                                            <div class="input-group input-group-merge">
                                                <div class="input-group input-group-floating">
                                                    <span class="input-group-text bg-lighter">[*]</span>
                                                    <div class="form-floating">
                                                        <input id="usulan_barang" onkeyup="sum_persediaan();" value="{{ $usulan_barang_details->jumlah_usulan_barang }}" class="form-control bg-lighter" id="basic-addon21" aria-label="Username" aria-describedby="basic-addon21" />
                                        ...
                                        <div class="col-6 col-md-12">
                                            <div class="form-floating form-floating-outline">
                                                <select name="id_usulan_barang"  class="select2 form-select form-select-lg" data-allow-clear="true">
                                                    <option value="{{$usulan_barang_details->id_usulan_barang}}">{{$usulan_barang_details->usulan_barang->no_usulan_barang}}</option>
                                                    @foreach ($usulan_barangs as $item)
                                                    <option value="{{$item->id_usulan_barang}}">{{$item->no_usulan_barang}}</option>
                                                    @endforeach
                                                </select>
                                                <label for="floatingSelect">No Usulan Barang</label>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="mt-2">
                                ...
                                <a href="{{ route('rekap_usulans.index', ['id' => $usulan_barang_details->usulan_barang->id_usulan_barang]) }}" class="btn btn-outline-secondary">Kembali</a>
                            </div>
                        </div>
                    </div>
                </div>
