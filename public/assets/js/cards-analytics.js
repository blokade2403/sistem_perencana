...
(function () {
  ...
  const projectTimelineEl = document.querySelector('#projectTimelineChart'),
    labels = ['Belanja Pegawai', 'Belanja Barang Jasa', 'Belanja Persediaan', 'Belanja Modal', 'Belanja Bangunan'],
    labelsResponsive = ['Belanja Pegawai', 'Belanja Barang Jasa', 'Belanja Persediaan', 'Belanja Modal', 'Belanja Bangunan'],
