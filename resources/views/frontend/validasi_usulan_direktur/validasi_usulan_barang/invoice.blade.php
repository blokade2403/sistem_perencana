                                ...
                                <tbody>
                                    <tr>
                                        <td colspan="4" class="align-top px-4 py-3">
                                            <p class="mb-2">
                                                <span class="me-1 fw-semibold">Status Sebelumnya: <span class="badge bg-label-success">{{$no_inv->status_permintaan_barang}}</span> </span>
                                            </p>
                                            ...
                                            {{-- <p class="mb-2">
                                                ...
                                                <span class="fa-xs">Tanggal Usulan : {{$no_inv->created_at}} </span>
                                        </td>
                                    ...
                                    <div class="col-md-6 m-3">
                                        <div class="col-12">
                                            <div class="form-floating form-floating-outline">
                                                <div class="mb-3">
                                                    <label for="formFileMultiple" class="form-label badge bg-label-danger">Upload Dokumen Usulan Barang Yang sudah di TTD</label>
                                ...
                                <div class="row">
                                    <div class="col-md-4 m-3">
                                        <div class="demo-inline-spacing">
                                            <div class="mb-3">
                                                <a href="{{route('validasi_usulan_barang_direkturs.index')}}" class="btn btn-label-secondary">
                                                    Back
                                                </a>
                                                {{-- <button type="submit" class="btn btn-primary" id="pilihBarang" onclick="return validateForm()">Save changes</button> --}}
