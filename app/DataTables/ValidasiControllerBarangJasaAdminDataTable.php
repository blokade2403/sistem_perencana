...
class ValidasiControllerBarangJasaAdminDataTable extends DataTable
{
            ...
            ->addColumn('action', function ($row) {
                ...
                <div class="demo-inline-spacing">
                    <div class="d-flex justify-content-start align-items-center gap-2">
                        <a href="' . route('validasi_barang_jasa_admins.edit', $row->id_rkbu) . '" class="btn btn-icon btn-primary waves-effect" data-bs-toggle="tooltip" title="Edit Data">
                        ...
                        <form action="' . route('validasi_barang_jasa_admins.destroy', $row->id_rkbu) . '" method="POST" class="delete-form">
    ...
    {
        return $this->builder()
            ->setTableId('validasicontrollerbarangjasaadmin-table')
