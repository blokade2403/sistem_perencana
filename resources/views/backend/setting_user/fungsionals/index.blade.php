                            ...
                            <tbody>
                                ...
                                <tr>
                                    @php
                                        $no = 1;
                                    @endphp
                                    @foreach ($fungsionals as $key)
                                    <td>{{ $no++ }}</td>
                                    <td>{{ $key->jabatan_fungsional }}</td>
                                        <td>
                                            <div class="btn-group" id="dropdown-icon-demo">
                                                ...
                                                <ul class="dropdown-menu">
                                                    <li>
                                                        <a href="{{ route('fungsionals.edit', $key->id_fungsional) }}" class="dropdown-item d-flex align-items-center"><i class="mdi mdi-chevron-right scaleX-n1-rtl"></i>Edit</a>
                                                    </li>
                                                    <form action="{{ route('fungsionals.destroy', $key->id_fungsional) }}" method="POST">
                                                        @csrf
                                                        @method('DELETE')
