       ...
       <div class="col-lg-12 col-12 mb-lg-0 mb-4">
           <div class="card invoice-preview-card">
               <div class="card-body">
                   ...
                   <form action="{{ route('usulan_spj_persediaans.updateStatus', $no_inv->id_spj) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    {{-- {{$no_inv->id_spj}} --}}
                    ...
                    <div class="card-body">
                        ...
                        <div class="mt-2">
                                ...
                                <a href="{{route('usulan_spj_persediaans.index')}}" class="btn btn-label-secondary">
                                    Kembali
                                </a>
