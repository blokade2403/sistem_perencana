...
<div class="content-wrapper">
    <!-- Content -->
        ...
        <form id="confirmSubmitForm" class="needs-validation" method="POST" action="{{ route('sumber_danas.update', $SumberDana->id) }}">
            @csrf
            @method('PUT')
            <div class="col-xl-12">
                <div class="card-body">
                                        ...
                                        <div class="col-12 col-md-12">
                                            <div class="input-group input-group-merge">
                                                ...
                                                <div class="form-floating form-floating-outline">
                                                    <input type="text" class="form-control" name="nama_sumber_dana" value="{{$SumberDana->nama_sumber_dana}}" id="basic-addon11" placeholder="John Doe" aria-label="tahun_anggaranname" aria-describedby="basic-addon11" />
