...
class ValidasiUsulanBarangDirekturController extends Controller
{
    ...
    public function show($id_usulan_barang)
    {
        ...
        return view('frontend.validasi_usulan_direktur.validasi_usulan_barang.invoice', $data, compact('sub_kategori_rkbus', 'usulan_barangs', 'id_usulan', 'invoice'));
    }
