                                    ...
                                    @php
                                            ...
                                            <td>
                                                <div class="demo-inline-spacing">
                                                    ...
                                                    <a href="{{ route('validasi_usulan_persediaan_rkas.keranjang', $key->id_usulan_barang) }}" class="btn btn-icon btn-warning waves-effect waves-light">
                                                    ...
                                                    <a href="{{route('validasi_usulan_persediaan_rkas.show', $key->id_usulan_barang)}}" class="btn btn-icon btn-primary waves-effect waves-light">
                                                    ...
                                                    <a href="{{route('validasi_usulan_persediaan_rkas.show', $key->id_usulan_barang)}}" class="btn btn-icon btn-danger waves-effect waves-light">
                                                        <span class="tf-icon mdi mdi-checkbox-marked-circle-outline"></span>
                                                    </a>
                                                    @endif
                                                </div>
