...
use App\Models\ValidasiControllerPersediaanAdmin;
use Yajra\DataTables\Html\Builder as HtmlBuilder;
use Illuminate\Database\Eloquent\Builder as QueryBuilder;

class ValidasiControllerPersediaanAdminDataTable extends DataTable
{
            ...
            ->addColumn('action', function ($row) {
                ...
                <div class="demo-inline-spacing">
                    <div class="d-flex justify-content-start align-items-center gap-2">
                        <a href="' . route('validasi_persediaan_admins.edit', $row->id_rkbu) . '" class="btn btn-icon btn-primary waves-effect" data-bs-toggle="tooltip" title="Edit Data">
                        ...
                        <form action="' . route('validasi_persediaan_admins.destroy', $row->id_rkbu) . '" method="POST" class="delete-form">
    ...
    {
        return $this->builder()
            ->setTableId('validasicontrollerpersediaanadmin-table')
    ...
    {
        return 'ValidasiControllerPersediaanAdmin_' . date('YmdHis');
    }
}
