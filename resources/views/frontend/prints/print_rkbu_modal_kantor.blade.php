...
<table class="table-data">
    ...
    <tr class="sub-header-parent">
        <td colspan="10">{{ $jenisKategori->kode_jenis_kategori_rkbu }}. {{ $jenisKategori->nama_jenis_kategori_rkbu }}</td>
    </tr>
        @php
        ...
        <tr class="sub-header-parent">
            <td colspan="10">{{ $obyekBelanja->kode_obyek_belanja }}. {{ $obyekBelanja->nama_obyek_belanja }}</td>
        </tr>
            @php
            ...
            <tr class="sub-header-parent">
                ...
                <tr class="sub-header-parent">
                    ...
                    <tr class="sub-header">
                        <td colspan="10">{{ $subKategori->nama_sub_kategori_rkbu }}</td>
                    </tr>
                    @php
                        $subKategoriNumber = 1;
                    @endphp
                    ...
                    @foreach ($categories->where('kode_sub_kategori_rkbu', $subKategori->kode_sub_kategori_rkbu) as $rkbu)
                        <tr>
                            ...
                            <td width="22%"><b>{{ $rkbu->nama_barang }}</b>
                                <br/><span class="text-left">Pengusul: {{ $rkbu->nama_user ?? '-' }}</span>
    ...
    <table border="0">
        <tr bgcolor="#ffffff">
            ...
            <th colspan="4" width="28%" align="left"><h4>Total Anggaran</h4></th>
