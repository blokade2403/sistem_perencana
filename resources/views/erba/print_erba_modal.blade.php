...
<div class="container">
    ...
    <div class="info">
        <table border="0" cellspacing="1" cellpadding="1" width="100%">
            <tr>
                <th width="45%" align="left" style="font-weight: bold;">5.2.02 Belanja Modal Peralatan Mesin</th>
            </tr>
            <tr>
                <td width="45%" align="left" style="font-weight: normal;">Belanja Modal Peralatan Mesin</td>
            </tr>
        </table>
    </div>
