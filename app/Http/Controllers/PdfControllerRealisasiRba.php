...
class PdfControllerRealisasiRba extends Controller
{
    public function downloadPDF(Request $request)
    {
        ...
        $htmlBody = view('frontend.prints.print_realisasi_kertas_kerja', compact('rkbus', 'pdf', 'tanggal_perencanaans', 'total_anggaran_blud', 'nama_rumah_sakit', 'nama_pejabat', 'nip_pejabat_kabag', 'nip_direktur', 'nama_direktur', 'sub_kategori_rkbus', 'status_validasi_rka', 'categories', 'namaProgram', 'namaKegiatan', 'namaSubKegiatan', 'kodeProgram', 'kodeKegiatan', 'kodeSubKegiatan', 'jenis_belanja_data'))->render();
