...
@section('container')
    <div class="card-body">
                            ...
                            <table id="example" class="table table-striped" style="width:100%">
                                ...
                                <tbody>
                                    @php
                                            ...
                                            <td>
                                                <a href="{{ route('usulan_spj_barjas.show', $key->id_spj )}}" class="btn btn-sm btn-info">
                                            ...
                                            <td>
                                                ...
                                                <form action="{{ route('usulan_spj_barjass.destroy', $key->id_spj) }}" method="POST" class="delete-form">
                                                    @csrf
                                                    @method('DELETE')
        ...
        @include('frontend.partials.modal_usulan_spj_no_usulan_barang')
