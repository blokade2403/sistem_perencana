<div class="col-md-6">
    <div class="card mb-4">
        <form class="needs-validation" method="POST" id="form-konfirm" action="" novalidate>
            <h5 class="card-header"> Verifikasi PPTK</h5>
                ...
                <div id="creditCardForm" class="row g-4">
                    ...
                    <div class="col-6 col-md-6">
                        <div class="form-floating form-floating-outline">
                            <input type="datetime-local" name="tgl_verif_pptk" value="{{$no_inv->tgl_verif_pptk; }}" class="form-control" id="html5-datetime-local-input" placeholder="----/--/--">
                    ...
                    <div class="col-12 col-md-6">
                        <div class="form-floating form-floating-outline">
                            <select name="id_status_spj" class="select2 form-select form-select-lg" data-allow-clear="true">
                                ...
                                <option value="13">Proses Verifikasi PPTK</option>
                            </select>
