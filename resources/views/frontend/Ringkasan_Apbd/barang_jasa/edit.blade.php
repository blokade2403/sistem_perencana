...
<div class="content-wrapper">
    <!-- Content -->
        ...
        @endif
        <form class="needs-validation" action="{{ route('validasi_barang_jasa_apbd_admins.update', $rkbuBarangJasa->id_rkbu) }}"  method="POST" id="confirmSubmitForm" enctype="multipart/form-data" validate>
            @csrf
            @method('PUT')
            <div class="col-xl-12">
                <div class="card-body">
                                ...
                                <div class="col-md-6">
                                    <div id="creditCardForm" class="row g-4">
                                        <div class="col-12 col-md-6">
                                            <div class="form-floating form-floating-outline">
                                                <input type="number" id="vol1" onkeyup="sum();" name="vol_1" value="{{$rkbuBarangJasa->vol_1}}" class="form-control" placeholder="Vol 1"  />
                                        ...
                                        <div class="col-12 col-md-4">
                                            <div class="form-floating form-floating-outline">
                                                <div class="input-group input-group-merge">
                                                    ...
                                                    <div class="form-floating form-floating-outline">
                                                        <input type="number" step="any" min="0" max="100"  class="form-control" value="{{$rkbuBarangJasa->ppn}}" id="persen" name="ppn" onkeyup="sum();" aria-label="Amount (to the nearest dollar)" />
                                                        <label>PPN</label>
                                                    </div>
                            ...
                            <div id="formAccountSettings">
                                <div class="row">
                                    ...
                                    <div class="mt-2">
                                        ...
                                        <button type="button" class="btn btn-primary me-2" data-bs-toggle="modal" data-bs-target="#onboardImageModal" onclick="saveChanges()">Save changes</button>
                                        <a href="{{route('validasi_barang_jasa_apbd_admins.index')}}" class="btn btn-outline-secondary">Kembali</a>
                                        @else
