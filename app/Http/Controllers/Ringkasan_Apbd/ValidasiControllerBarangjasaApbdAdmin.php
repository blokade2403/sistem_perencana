...
class ValidasiControllerBarangjasaApbdAdmin extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('frontend.Ringkasan_Apbd.barang_jasa.index', compact('rkbus', 'total_anggaran', 'sub_kategori_rkbus', 'status_validasi_rka', 'currentJenisKategori'));
    }
    ...
    public function edit(string $id)
    {
        ...
        return view('frontend.Ringkasan_Apbd.barang_jasa.edit', compact('rkbuBarangJasa', 'user', 'rekening_belanja', 'status_validasi_rka', 'status_validasi', 'komponens', 'sub_kategori_rkbus', 'uraian_satu', 'uraian_dua'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        // Redirect dengan pesan sukses
        return redirect()->route('validasi_barang_jasa_apbd_admins.index')->with('success', 'Data berhasil diperbarui.');
    }
    ...
    public function destroy(string $id)
    {
        ...
        if (!$rkbu) {
            return redirect()->route('validasi_barang_jasa_apbd_admins.index')
