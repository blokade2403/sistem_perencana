                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <div class="d-flex justify-content-center align-item-center gap-2">
                                            <a href="{{ route('usulan_belanja_barjas_admin_ppks.edit', $item->id_usulan_barang_detail) }}" class="btn btn-icon btn-outline-primary waves-effect">
                               ...
                               <div class="row">
                                   <div class="col-md-4 m-3">
                                       <div class="demo-inline-spacing">
                                           <div class="mb-3">
                                               <a href="{{route('usulan_belanja_barjas_admin_ppks.index')}}" class="btn btn-label-secondary">
                                                   Kembali
                                               </a>
