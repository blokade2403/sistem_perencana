                                        ...
                                        <div class="user-profile-info">
                                            ...
                                            <div class="btn-toolbar demo-inline-spacing" role="toolbar" aria-label="Toolbar with button groups">
                                                <div class="btn-group" role="group" aria-label="First group">
                                                    <a href="{{route('status_validasi_rkas.create')}}" class="btn btn-outline-secondary btn-primary">
                    ...
                    <div class="card">
                        ...
                        <table id="example" class="table table-bordered" style="min-width: 845px">
                            <thead>
                                <tr>
                                    <th>No</th>
                                    <th>ID Status Validasi RKA</th>
                                    <th>Nama Status Validasi RKA</th>
                                    <th>Action</th>
                                </tr>
                            </thead>
                            <tbody>
                                @if($status_validasi_rkas->isEmpty())
                                ...
                                <tr>
                                    @php
                                        $no = 1;
                                    @endphp
                                    @foreach ($status_validasi_rkas as $key)
                                    <td>{{ $no++ }}</td>
                                    <td>{{ $key->id_status_validasi_rka }}</td>
                                    <td>{{ $key->nama_validasi_rka }}</td>
                                        <td>
                                            <div class="btn-group" id="dropdown-icon-demo">
                                                ...
                                                <ul class="dropdown-menu">
                                                    <li>
                                                        <a href="{{ route('status_validasi_rkas.edit', $key->id_status_validasi_rka) }}" class="dropdown-item d-flex align-items-center"><i class="mdi mdi-chevron-right scaleX-n1-rtl"></i>Edit</a>
                                                    </li>
                                                    <li>
                                                        <a href="{{ route('status_validasi_rkas.show', $key->id_status_validasi_rka) }}" class="dropdown-item d-flex align-items-center"><i class="mdi mdi-chevron-right scaleX-n1-rtl"></i>Swo</a>
                                                    </li>
                                                    <form action="{{ route('status_validasi_rkas.destroy', $key->id_status_validasi_rka) }}" method="POST" class="delete-form">
                                                        @csrf
                                                        @method('DELETE')
