...
<form class="needs-validation" method="POST" action="{{ route('usulan_barang_barjass.update', $usulan_barang_details->id_usulan_barang_detail) }}" id="confirmSubmitForm" enctype="multipart/form-data" validate>
    @csrf
    @method('PUT')
                    ...
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            ...
                            <div class="mt-2">
                                ...
                                <a href="{{ route('usulan_barang_barjass.keranjang', ['id' => $usulan_barang_details->usulan_barang->id_usulan_barang]) }}" class="btn btn-outline-secondary">Kembali</a>
                            </div>
                        </div>
                    </div>
                </div>
