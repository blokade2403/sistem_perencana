...
<div class="container">
    ...
    <div class="info">
        <table border="0" cellspacing="1" cellpadding="1" width="100%">
            ...
            <tr>
                <th width="10%" align="left" style="font-weight: bold;">Total Anggaran</th>
                <td width="65%" align="left" style="font-weight: bold;">: {{ $kodeProgram }}</td>
                <th width="5%" align="left" style="font-weight: bold;">Unit</th>
                <td width="20%" align="left" style="font-weight: bold;">: {{ $kodeProgram }}</td>
            </tr>
        </table>
...
<table class="table-data">
    ...
    <tbody>
        ...
        @foreach ($categories as $category)
            <tr class="sub-header">
                <th width="99%">{{ $category->kode_jenis_belanja }}. {{ $category->nama_jenis_belanja }}</th>
            </tr>
                    ...
                    <tr class="sub-header-parent">
                        ...
                        <tr class="sub-header-parent">
                            ...
                            <tr bgcolor="#ffffff">
                                ...
                                <td width="6%" align="center">{{$rkbu->tempat_tgl_lahir}}</td>
...
<table cellspacing="1" cellpadding="1">
    <tr bgcolor="#ffffff">
      <th colspan="10" rowspan="2" width="63%" style="text-align:center;line-height:7px;"><h1></h1></th>
      <th colspan="2" width="26%" align="center"><h4>Total</h4></th>
      <th width="10%" align="center"><h4>Rp. </h4></th>
    </tr>
<tr bgcolor="#ffffff">
      <th colspan="2" align="center"><h4>Grand Total</h4></th>
      <th width="10%" align="center"><h4>Rp. {{number_format($total_anggaran)}}</h4></th>
