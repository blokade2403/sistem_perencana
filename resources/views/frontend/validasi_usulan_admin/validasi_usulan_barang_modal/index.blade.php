    ...
    <div class="card-body">
        <!-- Header -->
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        <form action="{{ route('validasi_usulan_barang_modals.index') }}" method="GET">
                                            ...
                                            <td>
                                                <div class="d-flex align-items-center gap-2">
                                                    ...
                                                    @if ($key->usulanBarangDetails->isEmpty())
                                                        <form action="{{ route('validasi_usulan_barang_modals.delete', $key->id_usulan_barang) }}" method="POST" class="delete-form m-0">
                                                            @csrf
                                                            @method('DELETE')
                                                    ...
                                                    <a href="{{ route('validasi_usulan_barang_modals.keranjang', $key->id_usulan_barang) }}" class="btn btn-icon btn-warning waves-effect waves-light">
                                                    ...
                                                    <a href="{{route('validasi_usulan_barang_modals.show', $key->id_usulan_barang)}}" class="btn btn-icon btn-primary waves-effect waves-light">
