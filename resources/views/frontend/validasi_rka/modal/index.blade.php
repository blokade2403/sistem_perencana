            ...
            <div class="card-body">
                                        ...
                                        <div class="user-profile-info">
                                            ...
                                            <ul class="list-inline mb-0 d-flex align-items-center flex-wrap justify-content-sm-start justify-content-center gap-2">
                                                ...
                                                <div class="demo-inline-spacing">
                                                    ...
                                                    @endif
                                                    <a href="{{route('validasi_modal_rkas.downloadPDF_ValidasiModalKabag')}}" class="btn rounded-pill btn-label-warning waves-effect">
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                             <!-- Filter Form -->
                             <form action="{{ route('validasi_modal_rkas.index') }}" method="GET">
                                @include('frontend.partials.filter_rkbu')
                            </form>
                            <form action="{{ route('validasi_modal_rkas.massValidasi') }}" method="POST">
                                @csrf
                                <input type="hidden" name="id_jenis_kategori_rkbu" value="modal">
                                    ...
                                    @include('frontend.partials.modal_detail_rkbu')
                                            <div class="demo-inline-spacing">
                                                <div class="d-flex justify-content-start align-items-center gap-2">
                                                    ...
                                                    <a href="{{ route('validasi_modal_rkas.edit', $rkbus->id_rkbu) }}" class="btn btn-icon btn-primary waves-effect" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-custom-class="tooltip-primary" data-bs-original-title="Edit Data">
                                                    ...
                                                    {{-- <form action="{{route('validasi_barang_jasa_rkas.destroy', $rkbus->id_rkbu)}}" method="POST" class="delete-form">
                                                        @csrf
                                                        @method('DELETE')
