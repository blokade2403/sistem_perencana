                        ...
                        <div class="card-body pt-1">
                            <div class="row">
                                        ...
                                        <div class="col-12 col-md-12">
                                            <div class="input-group input-group-merge">
                                                ...
                                                <div class="form-floating form-floating-outline">
                                                    <input type="text" class="form-control" name="jabatan_fungsional" value="{{$fungsional->jabatan_fungsional}}" id="basic-addon11" placeholder="John Doe" aria-label="jabatan-name" aria-describedby="basic-addon11" />
                                ...
                                <div class="mt-2">
                                    ...
                                    <a href="{{route('fungsionals.index')}}" class="btn btn-outline-secondary">Back</a>
                                </div>
                            </div>
                        </div>
