...
<form class="needs-validation" method="POST" action="{{ route('usulan_belanja_per_admin_ppks.update', $usulan_barang_details->id_usulan_barang_detail) }}" id="confirmSubmitForm" enctype="multipart/form-data" validate>
    @csrf
    @method('PUT')
        <!-- Content -->
            <div class="col-xl-12">
                                            ...
                                            <div class="alert alert-warning mb-4 alert-dismissible" role="alert">
                                                ...
                                                <div class="input-group input-group-merge">
                                                    ...
                                                    <div class="form-floating form-floating-outline">
                                                        <input type="text" value="{{ $usulan_barang_details->rkbu->nama_barang }}" class="form-control" aria-label="Amount (to the nearest dollar)" />
                        ...
                        <div class="mb-3" data-repeater-list="group-a">
                            <div class="card-body pt-1">
                                                        ...
                                                        <div class="card-information me-2">
                                                            ...
                                                            <div class="input-group input-group-floating">
                                                                <div class="form-floating">
                                                                    <input name="nama_barang" value="{{ $usulan_barang_details->rkbu->nama_barang }}" class="form-control bg-lighter" id="basic-addon21" aria-label="Username" aria-describedby="basic-addon21" />
                                                                </div>
                                                            </div>
                                                        </div>
                                ...
                                <div class="mt-2">
                                    ...
                                    <a href="{{ route('usulan_belanja_per_admin_ppks.show',  ['id_usulan_barang' => $usulan_barang_details->id_usulan_barang])}}" class="btn btn-outline-secondary">Kembali</a>
                                </div>
                            </div>
                        </div>
                    </div>
