                                        ...
                                        <div class="col-12 col-md-6">
                                            <div class="input-group input-group-merge">
                                                ...
                                                <div class="form-floating form-floating-outline">
                                                    <input type="text" class="form-control" name="nama_uraian_1" value="{{$uraianSatu->nama_uraian_1}}" id="basic-addon11" placeholder="John Doe" aria-label="uraian_satuname" aria-describedby="basic-addon11" />
