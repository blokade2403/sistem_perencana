...
<div class="content-wrapper">
    <!-- Content -->
        ...
        @endif
        <form id="confirmSubmitForm" class="needs-validation" method="POST" action="{{ route('aktivitass.update', $aktivitass->id_aktivitas) }}">
            @csrf
            @method('PUT')
            <div class="col-xl-12">
                <div class="card-body">
                        ...
                        <div class="card-body pt-1">
                            <div class="row">
                                    ...
                                    <div id="creditCardForm" class="row g-4">
                                        <div class="col-12 col-md-6">
                                            <div class="input-group input-group-merge">
                                                ...
                                                <div class="form-floating form-floating-outline">
                                                    <input type="text" class="form-control" name="kode_aktivitas" value="{{$aktivitass->kode_aktivitas}}" id="basic-addon11" placeholder="Isi Nama aktivitas" aria-label="pejabatname" aria-describedby="basic-addon11" />
                                        ...
                                        <div class="col-12 col-md-6">
                                            <div class="input-group input-group-merge">
                                                <span class="input-group-text"> <i class="mdi mdi-account me-2"></i></span>
                                                <div class="form-floating form-floating-outline">
                                                    <input type="text" class="form-control" name="nama_aktivitas" value="{{$aktivitass->nama_aktivitas}}" id="basic-addon11" placeholder="Isi Nama aktivitas" aria-label="pejabatname" aria-describedby="basic-addon11" />
                                            ...
                                            <div class="input-group input-group-merge">
                                                <div class="form-floating form-floating-outline">
                                                    <select class="select2 form-select form-select-lg" data-allow-clear="true" name="id_program" >
                                                        <option value="{{$aktivitass->id_program}}">{{$aktivitass->program->kode_program}}.{{$aktivitass->program->nama_program}}</option>
                                            ...
                                            <div class="input-group input-group-merge">
                                                <div class="form-floating form-floating-outline">
                                                    <select name="id_sub_kegiatan" class="select2 form-select form-select-lg" data-allow-clear="true">
                                                        <option value="{{$aktivitass->id_sub_kegiatan}}">{{$aktivitass->sub_kegiatan->kode_sub_kegiatan}}. {{$aktivitass->sub_kegiatan->nama_sub_kegiatan}}</option>
                                ...
                                <div class="mt-2">
                                    ...
                                    <a href="/aktivitass" class="btn btn-outline-secondary">Back</a>
                                </div>
                            </div>
                        </div>
