...
<div class="demo-inline-spacing">
    ...
    <a href="{{ route('master_spj.edit', $key->id_master_spj) }}" 
       class="btn btn-icon btn-primary waves-effect {{ session('nama_level_user') !== 'Administrator' ? 'disabled' : '' }}" 
...
@endif
        ...
        {{-- <a href="{{route('master_spj.show', $key->id_master_spj)}}" class="btn btn-icon btn-primary waves-effect" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-custom-class="tooltip-primary" data-bs-original-title="Show Data">
            <span class="tf-icons mdi mdi-comment-edit"></span>
        </a> --}}
