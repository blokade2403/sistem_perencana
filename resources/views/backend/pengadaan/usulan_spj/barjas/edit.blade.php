...
<form class="needs-validation" method="POST" action="{{ route('usulan_spj_barjass.update', $usulan_barang_details->id_usulan_barang_detail) }}" id="confirmSubmitForm" enctype="multipart/form-data" validate>
    @csrf
    @method('PUT')
        <!-- Content -->
            <div class="col-xl-12">
                    ...
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            ...
                            <div class="mt-2">
                                ...
                                <a href="{{route('usulan_spj_barjas.show', ['id_spj' => $invo->id_spj])}}" class="btn btn-outline-secondary">Kembali</a>
                            </div>
                        </div>
                    </div>
                </div>
