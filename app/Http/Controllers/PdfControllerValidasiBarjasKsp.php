...
class PdfControllerValidasiBarjasKsp extends Controller
{
    public function downloadPDF(Request $request)
    {
        ...
        $htmlBody = view('frontend.prints.print_rkbu_modal_kantor', compact('rkbus', 'sumberDana', 'total_anggaran_terbilang', 'sumberDana', 'jabatan_kabag', 'nama_rumah_sakit', 'nama_pejabat', 'nip_pejabat_kabag', 'nip_direktur', 'nama_direktur', 'pdf', 'sub_kategori_rkbus', 'status_validasi_rka', 'total_anggaran', 'categories', 'namaProgram', 'namaAktivitas', 'namaKegiatan', 'namaSubKegiatan', 'kodeProgram', 'kodeKegiatan', 'kodeSubKegiatan'))->render();
