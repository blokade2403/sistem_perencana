...
class PdfControllerValidasiPersediaanKsp extends Controller
{
    public function downloadPDF(Request $request)
    {
        ...
        $htmlBody = view('frontend.prints.print_rkbu_persediaan', compact('rkbus', 'nama_tahun_anggaran', 'total_anggaran_terbilang', 'angka_tahun',  'jabatan_kabag', 'nama_rumah_sakit', 'nama_pejabat', 'nip_pejabat_kabag', 'nip_direktur', 'nama_direktur', 'pdf', 'sub_kategori_rkbus', 'status_validasi_rka', 'total_anggaran', 'categories', 'namaProgram', 'namaKegiatan', 'namaSubKegiatan', 'kodeProgram', 'kodeKegiatan', 'kodeSubKegiatan'))->render();
