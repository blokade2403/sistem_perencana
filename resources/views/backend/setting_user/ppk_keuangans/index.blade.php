                            ...
                            <tbody>
                                ...
                                <tr>
                                    @php
                                        $no = 1;
                                    @endphp
                                    @foreach ($ppk_keuangans as $key)
                                    <td>{{ $no++}}</td>
                                    <td>{{ $key->nama_ppk_keuangan }}</td>
                                    <td>{{ $key->nip_ppk_keuangan }}</td>
                                    <td>{{ $key->status }}</td>
                                        <td>
                                            <div class="btn-group" id="dropdown-icon-demo">
                                                ...
                                                <ul class="dropdown-menu">
                                                    <li>
                                                        <a href="{{ route('ppk_keuangans.edit', $key->id_ppk_keuangan) }}" class="dropdown-item d-flex align-items-center"><i class="mdi mdi-chevron-right scaleX-n1-rtl"></i>Edit</a>
                                                    </li>
                                                    <form action="{{ route('ppk_keuangans.destroy', $key->id_ppk_keuangan) }}" method="POST">
                                                        @csrf
                                                        @method('DELETE')
