...
<div class="content-wrapper">
    <!-- Content -->
        ...
        @endif
        <form class="needs-validation" action="{{route('rkbu_persediaans.update', $rkbuPersediaan->id_rkbu)}}"  method="POST" id="confirmSubmitForm" enctype="multipart/form-data" validate>
            @csrf
            @method('PUT')
            <div class="col-xl-12">
                <div class="card-body">
                                        ...
                                        <div class="form-floating form-floating-outline">
                                            <div class="input-group input-group-merge">
                                                <div class="input-group">
                                                    <input type="text" name="nama_barang" value="{{$rkbuPersediaan->nama_barang}}" id="nama_komponen" readonly class="form-control" placeholder="cari data komponen klik tombol cari -->" aria-label="Example text with button addon" aria-describedby="button-addon1" />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                                    ...
                                                    <div class="accordion-item">
                                                        ...
                                                        <div id="accordionWithIcon-2" class="accordion-collapse collapse">
                                                            <div class="accordion-body">
                                                                <input type="text" name="nama_barang" class="form-control" value="{{ $rkbuPersediaan->nama_barang }}" placeholder="Nama Kebutuhan Barang">
                                                                <input type="hidden" name="id_status_validasi" class="form-control" value="{{$rkbuPersediaan->id_status_validasi}}">
                                                                <input type="hidden" name="jumlah_vol" class="form-control" value="{{$rkbuPersediaan->jumlah_vol}}">
                                                                <input type="hidden" name="status_komponen" class="form-control" value="{{$rkbuPersediaan->status_komponen}}">
                                                                <input type="hidden" name="sisa_vol_rkbu" class="form-control" value="{{$rkbuPersediaan->sisa_vol_rkbu}}">
