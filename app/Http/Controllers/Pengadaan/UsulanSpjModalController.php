...
class UsulanSpjModalController extends Controller
{
    ...
    public function index($id_usulan_barang = null)
    {
        ...
        $jenis_kategori_modal = ['9cf70e1d-18e7-40fe-bdd3-b7dabf61877d', '9cf70e31-9b9e-4dea-8b39-5459f23f3f51', '9cf70e44-a25e-462e-8bce-6fd930a91c0b'];
        ...
        $usulan_barangs = UsulanBarang::with('sub_kategori_rkbu')
            ...
            ->whereIn('jenis_kategori_rkbus.id_jenis_kategori_rkbu',  $jenis_kategori_modal)
            ->select(
        ...
        return view('backend.pengadaan.usulan_spj.modal.index', compact('usulan_barangs', 'get_barangs', 'data_usulan_barangs', 'id_usulan', 'sub_kategori_rkbus'));
    }
    ...
    public function add(Request $request)
    {
        ...
        return redirect()->route('usulan_spj_modals.index')->with('success', 'SPJ berhasil disimpan!');
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('usulan_spj_modals.index')->with('success', 'Data berhasil ditransfer ke SPJ.');
    }
    ...
    public function show($id_spj)
    {
        ...
        return view('backend.pengadaan.usulan_spj.modal.invoice', $data);
    }
    ...
    public function edit($id)
    {
        ...
        // Kirim data ke view
        return view('backend.pengadaan.usulan_spj.modal.edit', compact('usulan_barang_details', 'rkbu', 'uraian1', 'uraian2', 'invo'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        if ($totalAnggaranSetelahUpdate <= $rkbu->total_anggaran) {
            ...
            return redirect()->route('usulan_spj_modals.index', $usulanBarangDetail->id_usulan_barang)
    ...
    public function delete($id_spj_detail)
    {
        ...
        try {
            ...
            // Redirect dengan pesan sukses
            return redirect()->route('usulan_spj_modals.index')->with('success', 'Data SPJ berhasil dihapus.');
        } catch (\Exception $e) {
    ...
    public function updateStatus(Request $request, $id_spj)
    {
        try {
            ...
            return redirect()->route('usulan_spj_modals.index')
