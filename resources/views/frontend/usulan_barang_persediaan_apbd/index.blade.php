...
@section('container')
    <div class="card-body">
                            ...
                            <table id="example" class="table table-striped" style="width:100%">
                                ...
                                <tbody>
                                    @php
                                            ...
                                            @include('frontend.partials.modal_komponen_usulan_barang_persediaan')
                                            </td>
                                            <td><a href="{{ route('usulan_barang_persediaans.keranjang', $key->id_usulan_barang) }}" class="btn btn-sm btn-info">
                                            ...
                                            <td>
                                                ...
                                                <!-- Tombol Delete aktif jika tidak ada usulan_barang_details -->
                                                <form action="{{ route('usulan_barang_persediaans.delete', $key->id_usulan_barang) }}" method="POST" class="delete-form">
                                                    @csrf
                                                    @method('DELETE')
                                                ...
                                                @else
                                                <!-- Tombol Delete disabled jika ada usulan_barang_details -->
        ...
        @include('frontend.partials.modal_usulan_barang_sub_kategori_persediaan')
