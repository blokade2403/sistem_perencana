...
<div class="content-wrapper">
    <!-- Content -->
        ...
        @endif
        <form class="needs-validation" action="{{route('validasi_persediaan_admins.update', $rkbuPersediaan->id_rkbu)}}"  method="POST" id="confirmSubmitForm" enctype="multipart/form-data" validate>
            @csrf
            @method('PUT')
            <div class="col-xl-12">
                <div class="card-body">
                                ...
                                <div class="col-md-6 ">
                                    ...
                                    <div id="creditCardForm" class="row g-4">
                                        ...
                                        <div class="col-6 col-md-12 mb-4">
                                            <div class="form-floating form-floating-outline">
                                                <select id="subKategoriSelect" name="id_kode_rekening_belanja" class="select2 form-select form-select-lg" data-allow-clear="true">
                                                    <option value="{{$rkbuPersediaan->id_kode_rekening_belanja}}">{{ $rkbuPersediaan->rekening_belanjas->kode_rekening_belanja}}. {{ $rkbuPersediaan->rekening_belanjas->nama_rekening_belanja}}</option>
                                        ...
                                        <div class="col-6 col-md-12 mb-4">
                                            <div class="form-floating form-floating-outline">
                                                <select  name="id_user" class="select2 form-select form-select-lg" data-allow-clear="true">
                                                    <option value="{{$rkbuPersediaan->id_user}}">{{ $rkbuPersediaan->users->nama_lengkap}}</option>
                            ...
                            <div class="row">
                                <div class="col-12 col-md-6">
                                    <div class="form-floating form-floating-outline">
                                        ...
                                        <label for="id_status_validasi">Status Validasi KSP/KaIns</label>
                                    </div>
                                </div>
                                <div class="col-12 col-md-6">
                            ...
                            <div id="formAccountSettings">
                                <div class="row">
                                    ...
                                    <div class="mt-2">
                                        ...
                                        <button type="button" class="btn btn-primary me-2" data-bs-toggle="modal" data-bs-target="#onboardImageModal" onclick="saveChanges()">Save changes</button>
                                        <a href="{{route('validasi_persediaan_admins.index')}}" class="btn btn-outline-secondary">Kembali</a>
                                        @else
