...
<div class="content-wrapper">
    <!-- Content -->
        ...
        @endif
        <form id="confirmSubmitForm" class="needs-validation" method="POST" action="{{ route(('admin_pendukungs.store')) }}">
            @csrf
            <div class="col-xl-12">
                <div class="card-body">
                    <div class="card mb-4">
                                    ...
                                    <div id="creditCardForm" class="row g-4">
                                        <div class="col-12 col-md-5">
                                            <div class="input-group input-group-merge">
                                                ...
                                                <div class="form-floating form-floating-outline">
                                                    <input type="text" class="form-control" name="nama_pendukung_ppk" id="basic-addon11" placeholder="Isi Kode Kegiatan" aria-label="pejabatname" aria-describedby="basic-addon11" />
                                        ...
                                        <div class="col-12 col-md-7">
                                            <div class="input-group input-group-merge">
                                                <span class="input-group-text"> <i class="mdi mdi-account me-2"></i></span>
                                                <div class="form-floating form-floating-outline">
                                                    <input type="text" class="form-control" name="jabatan_pendukung_ppk" id="basic-addon11" placeholder="Isi" aria-label="pejabatname" aria-describedby="basic-addon11" />
                                        ...
                                        <div class="col-12 col-md-12">
                                            <div class="input-group input-group-merge">
                                                <div class="form-floating form-floating-outline">
                                                    <textarea name="nrk" class="form-control h-px-100" id="exampleFormControlTextarea1"></textarea>
