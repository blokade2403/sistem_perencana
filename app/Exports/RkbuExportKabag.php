...
class RkbuExportKabag implements FromCollection, WithHeadings, WithEvents
{
    /**
    ...
    public function collection()
    {
        ...
        return Rkbu::with(['subKategoriRkbu', 'sub_kategori_rekenings', 'ksp', 'sub_kegiatans', 'status_validasi_rka', 'status_validasi', 'rekening_belanjas', 'user'])
            ->whereHas('user', function ($query) use ($id_pejabat) {
                $query->where('id_pejabat', $id_pejabat); // Filter berdasarkan id_ksp dari tabel users
            })
