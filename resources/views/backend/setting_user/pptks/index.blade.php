                                        ...
                                        <div class="user-profile-info">
                                            ...
                                            <div class="btn-toolbar demo-inline-spacing" role="toolbar" aria-label="Toolbar with button groups">
                                                <div class="btn-group" role="group" aria-label="First group">
                                                    <a href="{{route('pptks.create')}}" class="btn btn-outline-secondary btn-primary">
                        ...
                        <table id="example" class="table table-bordered" style="min-width: 845px">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>{{ $key->nama_pptk }}</td>
                                    <td>{{ $key->nip_pptk }}</td>
                                    <td>{{ $key->id_tahun_anggaran }}</td>
                                    <td>
                                        @if ($key->status_pptk == 'aktif')
                                        ...
                                        <td>
                                            <div class="btn-group" id="dropdown-icon-demo">
                                                ...
                                                <ul class="dropdown-menu">
                                                    <li>
                                                        <a href="{{ route('pptks.edit', $key->id_pptk) }}" class="dropdown-item d-flex align-items-center"><i class="mdi mdi-chevron-right scaleX-n1-rtl"></i>Edit</a>
                                                    </li>
                                                    <form action="{{ route('pptks.destroy', $key->id_pptk) }}" method="POST">
                                                        @csrf
                                                        @method('DELETE')
