...
class ValidasiControllerModalApbdAdmin extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('frontend.Ringkasan_Apbd.modal.index', compact('rkbus', 'total_anggaran', 'sub_kategori_rkbus', 'status_validasi_rka', 'currentJenisKategori'));
    }
    ...
    public function edit(string $id)
    {
        ...
        $kategori = ['9cf70e1d-18e7-40fe-bdd3-b7dabf61877d', '9cf70e31-9b9e-4dea-8b39-5459f23f3f51', '9cf70e44-a25e-462e-8bce-6fd930a91c0b'];
        ...
        $sub_kategori_rkbus     = SubKategoriRkbu::join('kategori_rkbus', 'sub_kategori_rkbus.id_kategori_rkbu', '=', 'kategori_rkbus.id_kategori_rkbu')
            ->join('jenis_kategori_rkbus', 'kategori_rkbus.id_jenis_kategori_rkbu', '=', 'jenis_kategori_rkbus.id_jenis_kategori_rkbu')
            ->whereIn('jenis_kategori_rkbus.id_jenis_kategori_rkbu',  $kategori)
        ...
        return view('frontend.Ringkasan_Apbd.modal.edit', compact('rkbuBarangJasa', 'user', 'rekening_belanja', 'status_validasi_rka', 'status_validasi', 'komponens', 'sub_kategori_rkbus', 'uraian_satu', 'uraian_dua'));
    }

    public function massValidasi(Request $request)
    {
        $tahunAnggaran = Session::get('tahun_anggaran');
        $currentJenisKategori = $request->input('jenis_kategori_rkbu', ['9cf70e31-9b9e-4dea-8b39-5459f23f3f51', '9cf70e1d-18e7-40fe-bdd3-b7dabf61877d', '9cf70e44-a25e-462e-8bce-6fd930a91c0b']);
        $tahunAnggaran = Session::get('tahun_anggaran');
        $id_pejabat          = session('id_pejabat');
    ...
    public function update(Request $request, $id)
    {
        ...
        // Redirect dengan pesan sukses
        return redirect()->route('validasi_modal_apbd_admins.index')->with('success', 'Data berhasil diperbarui.');
    }
    ...
    public function destroy(string $id)
    {
        ...
        if (!$rkbu) {
            return redirect()->route('validasi_modal_apbd_admins.index')
