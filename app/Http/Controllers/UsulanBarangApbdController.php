...
class UsulanBarangApbdController extends Controller
{
    ...
    public function index($id_sub_kategori_rkbu = null)
    {
        ...
        return view('frontend.usulan_barang_apbd.index', compact('usulan_barangs', 'get_barangs', 'id_usulan', 'sub_kategori_rkbus'));
    }
    ...
    public function keranjang($id_usulan_barang)
    {
        ...
        return view('frontend.usulan_barang_apbd.keranjang', $data);
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('usulan_barang_barjas_apbds.index')->with('success', 'Data usulan barang berhasil ditambahkan!');
    }
    ...
    public function show($id_usulan_barang)
    {
        ...
        return view('frontend.usulan_barang_apbd.invoice', $data, compact('sub_kategori_rkbus', 'usulan_barangs', 'id_usulan', 'invoice'));
    }
    ...
    public function updateStatus(Request $request, $id)
    {
        ...
        return redirect()->route('usulan_barang_barjas_apbds.show', ['id_usulan_barang' => $usulanBarang->id_usulan_barang])
    ...
    public function edit($id)
    {
        ...
        // Kirim data ke view
        return view('frontend.usulan_barang_apbd.edit', compact('usulan_barang_details', 'rkbu', 'uraian1', 'uraian2'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        if ($totalAnggaranSetelahUpdate <= $rkbu->total_anggaran) {
            ...
            return redirect()->route('usulan_barang_barjas_apbds.index', $usulanBarangDetail->id_usulan_barang)
    ...
    public function destroy(UsulanBarang $usulanBarang)
    {
        ...
        return redirect()->route('usulan_barang_barjas_apbds.index')->with('success', 'RKBU Barang Jasa dan detailnya berhasil dihapus.');
    }
    ...
    public function doDeleteDetailKeranjang($id_usulan_barang_detail)
    {
        ...
        return redirect()->route('usulan_barang_barjas_apbds.index', $id_usulan_barang)->with('success', 'Detail usulan barang berhasil dihapus.');
    }
    ...
    public function doDelete($id_usulan_barang)
    {
        ...
        return redirect()->route('usulan_barang_barjas_apbds.index')->with('success', 'Data usulan barang berhasil dihapus.');
    }
}
