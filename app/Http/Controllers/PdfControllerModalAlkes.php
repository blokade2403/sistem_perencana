...
class PdfControllerModalAlkes extends Controller
{
    public function downloadPDFModalAlkes(Request $request)
    {
        ...
        $categories = DB::table('jenis_belanjas')
            ...
            ->join('sumber_danas', 'sumber_danas.id_sumber_dana', '=', 'sub_kegiatans.id_sumber_dana')
            // ->where('sumber_danas.id_sumber_dana', '!=', '9cdfcedb-cc19-4b65-b889-4a5e2dc0ebe3')
            ->where('jenis_belanjas.id_jenis_belanja', '9cf5ec2e-e7c6-4cdd-8c41-24a7cd5a594e')
            ->where('jenis_kategori_rkbus.id_jenis_kategori_rkbu', '9cf70e31-9b9e-4dea-8b39-5459f23f3f51')
            ->where('users.id_user', $id_user)
            ->where('rkbus.nama_tahun_anggaran', $tahunAnggaran)
        ...
        $html = '<table lines="none" bgcolor="white">
               ...
               <th  width="20%" align="left"><h4></h4>
                    <h6 align="center"><img src="assets/foto_rs/Jakarta.png" width="45" height="45"  ></h6>
               </th> 
               <th  width="60%" align="center">
                    <h3 align="center" style="font-size:6px; font-weight: normal;">PEMERINTAH PROVINSI DAERAH KHUSUS IBUKOTA JAKARTA</h3>
                    <h3 style="font-weight: normal; font-size:6px; line-height:0;" align="center">RUMAH SAKIT UMUM DAERAH CILINCING</h3>
                    <h3 align="center" style="font-size:6px; font-weight: normal;">RINGKASAN RENCANA BISNIS DAN ANGGARAN</h3>
                    <h3 style="font-weight: normal; font-size:6px; line-height:0;" align="center">TAHUN ANGGARAN ' . $tahunAnggaran . '</h3>
               </th>
               <th  width="20%" align="right"><h4></h4>
                    <h6 align="center"><img src="assets/foto_rs/file_1515408027.png" width="75" height="45"  ></h6>
               </th> 
               </tr>
        </table>';

        $html .= view('frontend.prints.print_rkbu_modal_kantor', compact('rkbus', 'total_anggaran_terbilang', 'sumberDana', 'jabatan_kabag', 'nama_rumah_sakit', 'nama_pejabat', 'nip_pejabat_kabag', 'nip_direktur', 'nama_direktur', 'pdf', 'sub_kategori_rkbus', 'status_validasi_rka', 'total_anggaran', 'categories', 'namaProgram', 'namaAktivitas', 'namaKegiatan', 'namaSubKegiatan', 'kodeProgram', 'kodeKegiatan', 'kodeSubKegiatan'))->render();
